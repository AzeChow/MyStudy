...
public class DgBcsQPDictPorHead extends JDialogBase {
	...
	private void showData() {
		List list = contractAction.findBcsQPDictPorHead(new Request(CommonVars
				.getCurrUser(), true));
		JTableListModelAdapter jTableListModelAdapter = new JTableListModelAdapter() {
			public List InitColumns() {
				...
				list.add(addColumn("手册编号", "dictPorEmsNo", 100));
		...
		jTable.getColumnModel().getColumn(4).setCellRenderer(
				new DefaultTableCellRenderer() {
					public Component getTableCellRendererComponent(
						...
						String dictEmsNo=(value == null ? "" : value.toString().trim());
						if(list.contains(dictEmsNo)){
	...
	class CheckBoxEditor extends DefaultCellEditor implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			for (Object obj : objs) {
				if (obj instanceof BcsQPDictPorHead) {
					BcsQPDictPorHead temp = (BcsQPDictPorHead) obj;
			...
			btnOk.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					for (int i = 0; i < list.size(); i++) {
						BcsQPDictPorHead dzscQPEmsPorWjHead = (BcsQPDictPorHead) list
								.get(i);
