 ...
 */
public class DgImpCustomsDeclarationList extends JInternalFrameBase {
	 ...
	 */
	public DgImpCustomsDeclarationList() {
		super();
		initialize();
		getButtonGroup();
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (tableModel == null || tableModel.getList().size() <= 0) {
						JOptionPane.showMessageDialog(
								DgImpCustomsDeclarationList.this, "没有数据可打印",
								"提示", JOptionPane.INFORMATION_MESSAGE);
						return;
					}
					CustomReportDataSource ds = new CustomReportDataSource(
							tableModel.getList());
					InputStream reportStream = DgImpCustomsDeclarationList.class
