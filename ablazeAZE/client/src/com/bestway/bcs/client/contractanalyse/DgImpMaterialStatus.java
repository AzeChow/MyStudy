 ...
 */
public class DgImpMaterialStatus extends JDialogBase {
		...
		if (jButton == null) {
			...
			jButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (contract == null) {
						JOptionPane.showMessageDialog(DgImpMaterialStatus.this,
...
}  //  @jve:decl-index=0:visual-constraint="283,110"
