 ...
 */
public class DgProductAnalyse extends JInternalFrameBase {
	...
	public void setVisible(boolean b) {
		if (b) {
			// List list=
			// this.contractAnalyseAction.findCommInfoImpExpAnalyse(new Request(
			// CommonVars.getCurrUser()),false,null,null,null,null,null,null);
			...
			jButton1.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (tableModel == null || tableModel.getList().size() <= 0) {
						JOptionPane.showMessageDialog(DgProductAnalyse.this,
								"没有数据可打印", "提示",
					...
					parameters.put("reportTitle", "出口成品流水帐");
		...
		tableModel = new JTableListModel(jTable, list,
				new JTableListModelAdapter() {
					public List InitColumns() {
						...
						list.add(addColumn("核销单号", "authorizeFile", 100));
...
//		CommonVars.castMultiplicationValue(jTable, 9, 8, 7,decimalLength);
