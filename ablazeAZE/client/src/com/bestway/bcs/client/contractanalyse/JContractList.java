 ...
 */
public class JContractList extends JList {
	...
	public JContractList(Boolean isExingContract, Boolean isCavContract) {

		this();

		showContractData(isExingContract, isCavContract);
	 ...
	 * @return
	 */
	public void setSelectedContracts(List<Contract> lsResult) {
		for (int i = 0; i < this.getModel().getSize(); i++) {
			Contract contract = (Contract) this.getModel().getElementAt(i);
			if (lsResult.contains(contract)) {
