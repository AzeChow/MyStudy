...
public class DgChangeExgSeqNum extends JDialogBase {
	...
	public void setVisible(boolean b) {
		if (b) {
			this.obj = (ContractExg) tableModel.getCurrentRow();
	...
	private void initialize() {
		this.setSize(new Dimension(205, 182));
		this
				.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
		this.setContentPane(getJContentPane());
		this.setTitle("变更成品序号");
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			jLabel2 = new JLabel();
			jLabel2.setBounds(new Rectangle(26, 76, 140, 25));
	...
	private JButton getBtnOk() {
		if (btnOk == null) {
			btnOk = new JButton();
			btnOk.setBounds(new Rectangle(23, 109, 63, 26));
			btnOk.setText("确定");
			btnOk.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (tfNewSeqNum.getValue() == null) {
						JOptionPane.showMessageDialog(DgChangeExgSeqNum.this,
...
//					}
					...
					contractAction.changeContractExgSeqNum(new Request(
	...
	private JButton getBtnCancel() {
		if (btnCancel == null) {
			...
			btnCancel.setBounds(new Rectangle(107, 109, 63, 26));
