...
public class DgBcsQPContractHead extends JDialogBase {
	...
	private void showData() {
		List list = contractAction.findBcsQPContract(new Request(CommonVars
				.getCurrUser(), true));
	...
	class CheckBoxEditor extends DefaultCellEditor implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			for (Object obj : objs) {
				if (obj instanceof BcsQPContract) {
					BcsQPContract temp = (BcsQPContract) obj;
			...
			btnOk.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					for (int i = 0; i < list.size(); i++) {
						BcsQPContract bcsQPContract = (BcsQPContract) list
								.get(i);
						if (bcsQPContract.getIsSelected()) {
							lsResult.add(bcsQPContract);
						}
					}
					dispose();
				}
	...
	private void selectAll(boolean isSelected) {
		...
		for (int i = 0; i < list.size(); i++) {
			BcsQPContract bcsQPContract = (BcsQPContract) list
					.get(i);
			bcsQPContract.setIsSelected(isSelected);
		}
