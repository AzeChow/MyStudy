...
public class DgContractCavExg extends JDialogBase {
...
//		 这里是控制焦点的顺序，以方便键盘的输！
		...
		components.add(this.tfTotalAmount);
		components.add(null);
		components.add(this.tfReworkExport);
	...
	private void initialize() {
		this.setSize(new Dimension(416, 362));
		this
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			jLabel61 = new JLabel();
			jLabel61.setBounds(new Rectangle(49, 240, 78, 22));
	...
	private ContractExgCav getContractExgCav() {
		return (ContractExgCav) tableModel.getCurrentRow();
	}

	private void fillData(ContractExgCav exgCav) {
		if (exgCav == null) {
			return;
		}
		exgCav
	...
	private void calExpTotalAmount() {
		ContractExgCav exgCav = this.getContractExgCav();
	...
	private void showData() {
		...
		if (exgCav != null) {
			...
			this.tfStockAmount
			.setValue(exgCav.getStockAmount());
		} else {
			this.tfName.setText("");
			this.tfSpec.setText("");
			this.tfUnit.setText("");
