...
public class DgBcsImportCustomsDeclaration extends
	...
	public DgBcsImportCustomsDeclaration() {
		...
		tfEmsNo.setBounds(234, 21, 206, 19);
	}
	...
	protected DgBaseImportCustomsDeclarationCommInfo getImportCustomsDeclarationCommInfo() {
		int impExpType=Integer.parseInt(((ItemProperty)this.cbbImpExpType.getSelectedItem()).getCode());
		String tradeCode="";
	...
	protected String checkCurrentRemainAmount() {
		...
		return ((ContractExeAction) this.baseEncAction).checkCurrentRemainAmount(new Request(CommonVars
				.getCurrUser()), commInfo, contract, isMaterial, impExpType, tradeCode);
	}
