...
public class DgUpdateOwpBomWaste extends JDialogBase {
	...
	public DgUpdateOwpBomWaste() {
		super();
		initialize();
	}

	public DgUpdateOwpBomWaste(boolean isModal) {
		super(isModal);
		initialize();
	}

	public DgUpdateOwpBomWaste(JFrame owner, boolean isModal) {
		super(owner, isModal);
		initialize();
	}

	public DgUpdateOwpBomWaste(Dialog owner, boolean isModal) {
		super(owner, isModal);
		initialize();
	}
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (cbbPFourCode.getSelectedIndex() < 0) {
						JOptionPane.showMessageDialog(
								DgUpdateOwpBomWaste.this, "请选择成品4码", "提示",
					...
					if (cbbMFourCode.getSelectedIndex() < 0) {
						JOptionPane.showMessageDialog(
								DgUpdateOwpBomWaste.this, "请选择料件4码", "提示",
								JOptionPane.INFORMATION_MESSAGE);
						return;
					} else {
					...
					if (tfWaste.getValue() == null) {
						JOptionPane.showMessageDialog(
								DgUpdateOwpBomWaste.this, "请输入损耗率!", "提示",
								JOptionPane.INFORMATION_MESSAGE);
						return;
					}
