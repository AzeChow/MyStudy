 ...
 */
public class DgFinanceSignInFecavBill extends JDialogBase {
	 ...
	 */
	public DgFinanceSignInFecavBill() {
		super();
		initialize();
		...
		if (btnOk == null) {
			...
			btnOk.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if ("".equals(tfSignInMan.getText().trim())) {
						JOptionPane.showMessageDialog(DgFinanceSignInFecavBill.this,
								"签收人不能为空,请检查输入", "提示",
								JOptionPane.OK_OPTION);
						return;
					}
					if (cbbSignInDate.getDate()==null) {
						JOptionPane.showMessageDialog(DgFinanceSignInFecavBill.this,
								"签收日期不能为空,请检查输入", "提示",
								JOptionPane.OK_OPTION);
						return;
					}
					String signInMan=tfSignInMan.getText();
					Date signInDate=cbbSignInDate.getDate();
					lsResult = fecavAction.financeSignInFecavBill(new Request(
							CommonVars.getCurrUser()),lsFecavBill,signInMan,signInDate);
					dispose();
				}
			});
		}
	...
	private JCalendarComboBox getJCalendarComboBox() {
		if (cbbSignInDate == null) {
			...
			cbbSignInDate.setBounds(new java.awt.Rectangle(112,58,191,24));
		}
	...
	private JTextField getJTextField() {
		if (tfSignInMan == null) {
			...
			tfSignInMan.setBounds(new java.awt.Rectangle(112,29,191,24));
		}
		return tfSignInMan;
	}
