 ...
 */
public class DgCavFecavBill extends JDialogBase {
			...
			btnOk.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if ("".equals(tfStrikeMan.getText().trim())) {
						JOptionPane.showMessageDialog(DgCavFecavBill.this,
								"核销人不能为空,请检查输入", "提示",
...
//						f.setCancelMan(signInMan);
//						f.setCancelDate(signInDate);
//						f.setFecavState(FecavState.CANCEL);
//					}
					lsResult = fecavAction.cancelAfterVerificationFecavBill(new Request(
