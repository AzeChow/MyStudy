 ...
 *
 */
public class PnChangeOthersInfo extends JPanel {
	...
	public TempOthersBillInfo getOtherBillInfo(){
		TempOthersBillInfo info=new TempOthersBillInfo();
