 ...
 *
 */
public class DgChangeItemsSeqNum extends JDialogBase {
	...
	private FixtureContractItems obj=null;
	...
	public FixtureContractAction getFixtureContractAction() {
		return fixtureContractAction;
	}

	public void setFixtureContractAction(FixtureContractAction contractAction) {
		this.fixtureContractAction = contractAction;
	}
	...
	public void setVisible(boolean b){
		if(b){
			this.obj=(FixtureContractItems)tableModel.getCurrentRow();
			...
			btnOk.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (tfNewSeqNum.getValue() == null) {
						JOptionPane.showMessageDialog(DgChangeItemsSeqNum.this,
					...
					fixtureContractAction.changeContractItemSeqNum(new Request(CommonVars
