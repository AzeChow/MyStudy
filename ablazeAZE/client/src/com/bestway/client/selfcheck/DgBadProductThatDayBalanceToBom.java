 ...
 */
public class DgBadProductThatDayBalanceToBom extends JDialogBase {
	 ...
	 * 
	 */
	public DgBadProductThatDayBalanceToBom() {
		super();
	...
	private void initUI() {
		...
		group.add(getRbBillDetail());
		group.add(getRbCheckBlance());
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			lbDataSoure.setBounds(new Rectangle(180, 14, 94, 22));
			...
			jLabel4 = new JLabel();
			jLabel4.setText("至");
			jLabel4.setBounds(new Rectangle(217, 78, 32, 22));
			jLabel3 = new JLabel();
			jLabel3.setText("至");
			jLabel3.setBounds(new Rectangle(219, 23, 32, 22));
			jLabel21 = new JLabel();
			jLabel21.setText("报关编码");
			jLabel21.setBounds(new Rectangle(250, 78, 65, 22));
			jLabel2 = new JLabel();
			jLabel2.setText("报关编码");
			jLabel2.setBounds(new Rectangle(6, 78, 65, 22));
			jLabel1 = new JLabel();
			jLabel1.setText("工厂料号");
			jLabel1.setBounds(new Rectangle(250, 23, 65, 22));
			jLabel = new JLabel();
			jLabel.setText("工厂料号");
			jLabel.setBounds(new Rectangle(6, 23, 65, 22));
			lbHsSpec = new JLabel();
			lbHsSpec.setText("报关规格");
			lbHsSpec.setBounds(new Rectangle(250, 105, 65, 22));
			lbHsName = new JLabel();
			lbHsName.setText("报关名称");
			lbHsName.setBounds(new Rectangle(6, 105, 65, 22));
			lbFactorySpec = new JLabel();
			lbFactorySpec.setText("工厂规格");
			lbFactorySpec.setBounds(new Rectangle(250, 51, 65, 22));
			lbDate = new JLabel();
			lbDate.setText("报表日期");
			lbDate.setLocation(new Point(16, 227));
			lbDate.setSize(new Dimension(65, 22));
			lbFactoryName = new JLabel();
			lbFactoryName.setText("工厂名称");
			lbFactoryName.setBounds(new Rectangle(6, 51, 65, 22));
			...
			jPanel1.setPreferredSize(new Dimension(1, 270));
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new Rectangle(15, 32, 157, 189));
	...
	private JCalendarComboBox getCbbEndDate() {
		if (cbDate == null) {
			...
			cbDate.setSize(new Dimension(90, 25));
			cbDate.setLocation(new Point(82, 227));
		}
		return cbDate;
	}
	...
	private JTextField getTfFactoryName() {
		if (tfFactoryName == null) {
			...
			tfFactoryName.setBounds(new Rectangle(73, 51, 116, 22));
		}
	...
	private JButton getBtnFactoryName() {
		if (btnFactoryName == null) {
			...
			btnFactoryName.setBounds(new Rectangle(190, 51, 20, 22));
			btnFactoryName
	...
	private JTextField getTfFactorySpec() {
		if (tfFactorySpec == null) {
			...
			tfFactorySpec.setBounds(new Rectangle(317, 51, 112, 22));
		}
	...
	private JButton getBtnFactorySpec() {
		if (btnFactorySpec == null) {
			...
			btnFactorySpec.setBounds(new Rectangle(430, 51, 20, 22));
			btnFactorySpec
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
	...
	private JTextField getTfHsName() {
		if (tfHsName == null) {
			...
			tfHsName.setBounds(new Rectangle(73, 105, 116, 22));
		}
		return tfHsName;
	}
	...
	private JButton getBtnHsName() {
		if (btnHsName == null) {
			...
			btnHsName.setText("...");
			btnHsName.setBounds(new Rectangle(190, 105, 20, 22));
	...
	private JTextField getTfHsSpec() {
		if (tfHsSpec == null) {
			...
			tfHsSpec.setBounds(new Rectangle(317, 105, 112, 22));
		}
		return tfHsSpec;
	}
	...
	private JButton getBtnHsSpec() {
		if (btnHsSpec == null) {
			...
			btnHsSpec.setText("...");
			btnHsSpec.setBounds(new Rectangle(430, 105, 20, 22));
	...
	private JCheckBox getCbSetName() {
		if (cbSetName == null) {
			...
			cbSetName.setLocation(new Point(670, 205));
			cbSetName.setSize(new Dimension(102, 21));
		}
		return cbSetName;
	}
	...
	private JCheckBox getCbShowNegative() {
		if (cbShowNegative == null) {
			...
			cbShowNegative.setLocation(new Point(670, 228));
	...
	private JCheckBox getCbFactoryByGroup() {
		if (cbFactoryByGroup == null) {
			...
			cbFactoryByGroup.setLocation(new Point(670, 178));
			cbFactoryByGroup.setSize(new Dimension(102, 21));
		}
	...
	private JButton getBtnSelect() {
		if (btnSelect == null) {
			...
			btnSelect.setSize(new Dimension(89, 22));
			btnSelect.setLocation(new Point(676, 30));
	...
	private List<Condition> getCheckBalanceCondition() {
		...
		// 库存类别
		finishedConditions.add(new Condition("and", null, "kcType", "=", "5",
				null));
		// 生效日期
	...
	class Find extends SwingWorker {
		...
		protected Object doInBackground() throws Exception {// 后台计算
			...
			// 查询
			CommonProgress
					.showProgressDialog(DgBadProductThatDayBalanceToBom.this);
			CommonProgress.setMessage("系统正在执行查询，请稍后...");
			String orderBy = "";
			// 原来的成品当日结存数据去折料
			materielType = MaterielType.BAD_PRODUCT;
			resultList = casCheckAction.getBadProductBillDtailToBom(
					new Request(CommonVars.getCurrUser()), finishedConditions,
					materialConditions, finishedConditionsBalance,
					rbCheckBlance.isSelected(), "", MaterielType.BAD_PRODUCT,
		...
		protected void done() {// 更新视图
			...
			try {
				...
				JOptionPane.showMessageDialog(
						DgBadProductThatDayBalanceToBom.this, "获取数据失败：！"
								+ e.getMessage(), "提示", 2);
			}
			if (list == null) {
				list = new ArrayList();
	...
	private JButton getBtnMimeograph() {
		if (btnMimeograph == null) {
			...
			btnMimeograph.setLocation(new Point(676, 61));
			btnMimeograph.setSize(new Dimension(89, 22));
			btnMimeograph
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
							try {
								...
								if (rbBillDetail.isSelected()) {
									...
									if (cbSetName.isSelected()) {// 2.只选了报关名称汇总
										System.out.println("hcl nameset");
										str = "report/CheckBalanceThatDayConvertGroupByComplex.jrxml.jasper";
									} else {
										str = "report/CheckBalanceThatDayConvert.jasper";
									}
									parameters.put("type", "数据来自：盘点导入");
									parameters.put("bomType", "残次品");
								}
								...
								.fillReport(masterReportStream, parameters, ds);
	...
	private JButton getBtnClose() {
		if (btnClose == null) {
			...
			btnClose.setText("关闭");
			btnClose.setLocation(new Point(676, 93));
			btnClose.setMnemonic(KeyEvent.VK_UNDEFINED);
			btnClose.setSize(new Dimension(89, 22));
			btnClose.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					DgBadProductThatDayBalanceToBom.this.dispose();
				}
			});
	...
	private void initTable(final List list) {
		...
		ColumnGroup g_product = new ColumnGroup("残次品");
	...
	public void combineTableBill() {
		...
		((MultiSpanCellTable) jTable).combineRowsByIndeies(new int[] { 1, 2, 3,
				4, 5, 6, 7, 8, 9 }, new int[] { 1, 2, 3, 4, 5, 6, 7, 8, 9 });
	}
	...
	private JTextField getTfPtPart() {
		if (tfPtPart == null) {
			...
			tfPtPart.setBounds(new Rectangle(73, 23, 116, 22));
	...
	private JTextField getTfCusPart() {
		if (tfCusPart == null) {
			...
			tfCusPart.setBounds(new Rectangle(73, 78, 116, 22));
	...
	private JTextField getTfPtPart1() {
		if (tfPtPart1 == null) {
			...
			tfPtPart1.setBounds(new Rectangle(317, 23, 112, 22));
		}
		return tfPtPart1;
	}
	...
	private JTextField getTfCusPart1() {
		if (tfCusPart1 == null) {
			...
			tfCusPart1.setBounds(new Rectangle(317, 78, 112, 22));
		}
		return tfCusPart1;
	}
	...
	private JButton getBtnFactoryName1() {
		if (btnFactoryName1 == null) {
			...
			btnFactoryName1.setBounds(new Rectangle(190, 23, 20, 22));
			btnFactoryName1
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setText("...");
			jButton.setBounds(new Rectangle(190, 78, 20, 22));
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setText("...");
			// jButton1.setEnabled(false);
			jButton1.setBounds(new Rectangle(430, 23, 20, 22));
	...
	private JButton getJButton2() {
		if (jButton2 == null) {
			...
			jButton2.setText("...");
			// jButton2.setEnabled(false);
			jButton2.setBounds(new Rectangle(430, 78, 20, 22));
	...
	public void setQueryCondition(Date startDate, Date endDate, String hsCode,
			String hsName, String hsSpec, String ptNo, String ptName,
			String ptSpec) {
		// 如果结束日期不为空
		if (endDate != null) {
			...
			// }else{
			// this.startDate.setDate(CommonUtils.getBeginDate(endDate.getYear(),
			// 0, 1));
			// }
		}
	...
	private JPanel getJPanelMaterial() {
		if (jPanelMaterial == null) {
			...
			jPanelMaterial.setBounds(new Rectangle(181, 130, 486, 137));
	...
	private JPanel getJPanelProduct() {
		if (jPanelProduct == null) {
			jLabel6 = new JLabel();
			jLabel6.setBounds(new Rectangle(219, 25, 20, 22));
			jLabel6.setText("至");
			jLabel53 = new JLabel();
			...
			jPanelProduct.setBounds(new Rectangle(180, 44, 486, 82));
	...
	private JButton getBtnRelation() {
		if (btnRelation == null) {
			...
			btnRelation.setBounds(new Rectangle(676, 124, 89, 22));
			...
			btnRelation.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (tableModel.getCurrentRow() == null) {
						JOptionPane.showMessageDialog(
								DgBadProductThatDayBalanceToBom.this,
								"请选择你要查看的资料", "确认", 1);
						return;
					}
	...
	private JPopupMenu getPmRelation() {
		if (pmRelation == null) {
			...
			pmRelation.add(getMiImpExpDetail());// 残次品进出仓帐

			pmRelation.add(getMiThatDayBalance());// 残次品当日结存

			pmRelation.add(getMiPandianDifferent());// 残次品结存与盘点差额ok2010.06.28
	...
	private JMenuItem getMiImpExpDetail() {
		if (miImpExpDetail == null) {
			...
			miImpExpDetail.setText("残次品进出仓帐");
			miImpExpDetail
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
							...
							dialog.setMaterialType(MaterielType.BAD_PRODUCT);
							dialog.setWaiFa(true);

							dialog.setTitle("残次品进出仓帐");
	...
	private JMenuItem getMiThatDayBalance() {
		if (miThatDayBalance == null) {
			...
			miThatDayBalance.setText("残次品当日结存");
			miThatDayBalance
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
	...
	private JMenuItem getMiPandianDifferent() {
		if (miPandianDifferent == null) {
			...
			miPandianDifferent.setText("残次品结存与盘点差额");
			miPandianDifferent
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
	...
	private JRadioButton getRbBillDetail() {
		if (rbBillDetail == null) {
			...
			rbBillDetail.setBounds(new Rectangle(275, 14, 76, 24));
	...
	private JRadioButton getRbCheckBlance() {
		if (rbCheckBlance == null) {
			...
			rbCheckBlance.setBounds(new Rectangle(353, 14, 89, 24));
