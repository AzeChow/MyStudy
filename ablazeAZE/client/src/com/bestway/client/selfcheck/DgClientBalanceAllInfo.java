...
public class DgClientBalanceAllInfo extends JDialogBase {
	...
	private JComboBox getCbbClientName() {
		if (cbbClientName == null) {
			...
			cbbClientName.setBounds(new Rectangle(137, 16, 158, 20));
		}
	...
	private JTextField getTfWareName() {
		if (tfWareName == null) {
			...
			tfWareName.setBounds(new Rectangle(137, 37, 158, 20));
		}
		return tfWareName;
	}
	...
	private JCalendarComboBox getCbbBeginDate() {
		if (cbbBeginDate == null) {
			...
			cbbBeginDate.setBounds(new Rectangle(137, 57, 158, 20));
		}
		return cbbBeginDate;
	}
	...
	private JTextField getTfWareSpec() {
		if (tfWareSpec == null) {
			...
			tfWareSpec.setBounds(new Rectangle(432, 37, 158, 20));
		}
		return tfWareSpec;
	}
	...
	private JCalendarComboBox getCbbEndDate() {
		if (cbbEndDate == null) {
			...
			cbbEndDate.setBounds(new Rectangle(432, 57, 158, 20));
		}
		return cbbEndDate;
	}
	...
	private JPanel getPnTop() {
		if (pnTop == null) {
			jLabel1 = new JLabel();
			jLabel1.setBounds(new Rectangle(322, 57, 16, 18));
			jLabel1.setText("至");
			pnTop = new JPanel();
			...
			jLabel7.setBounds(new Rectangle(367, 57, 62, 18));
			jLabel5 = new JLabel();
			jLabel5.setText("商品规格");
			jLabel5.setBounds(new Rectangle(367, 37, 62, 18));
			jLabel3 = new JLabel();
			jLabel3.setText("报表日期");
			jLabel3.setBounds(new Rectangle(74, 57, 62, 18));
			jLabel2 = new JLabel();
			jLabel2.setText("商品名称");
			jLabel2.setBounds(new Rectangle(74, 37, 62, 18));
			jLabel = new JLabel();
			jLabel.setText("客户名称");
			jLabel.setBounds(new Rectangle(74, 17, 62, 18));
