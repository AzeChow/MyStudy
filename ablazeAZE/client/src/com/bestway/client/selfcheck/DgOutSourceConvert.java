...
public class DgOutSourceConvert extends JDialogBase {
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			lbHsSpec = new JLabel();
			lbHsSpec.setBounds(new Rectangle(342, 54, 79, 18));
			...
			lbPtSpec = new JLabel();
			lbPtSpec.setBounds(new Rectangle(342, 79, 77, 19));
	...
	private JCalendarComboBox getCbEndDate() {
		if (cbEndDate == null) {
			...
			cbEndDate.setLocation(new Point(412, 155));
	...
	class Find extends SwingWorker{
		...
		protected Object doInBackground() throws Exception {//后台计算
			...
			List list = null;
			//查询
			CommonProgress.showProgressDialog(DgOutSourceConvert.this);
...
//			}
//			else{
			list = casCheckAction.getCurrentOutSource(new Request(CommonVars.getCurrUser()),casConvert,billDetail);
//			}
			return list;
		}
		...
		if (btClose == null) {
			...
			btClose.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					DgOutSourceConvert.this.dispose();
	...
	private JButton getBtnComplexCode() {
		if (btnComplexCode == null) {
			...
			btnComplexCode.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					String materialType = getMaterielType();
					Object object = CasQuery.getInstance().findHsNoFromStatCusNameRelationHsnmByXiaoK("outSource");
					if (object != null) {
		...
		if (btnHsName == null) {
			...
			btnHsName.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					.findHsNameFromStatCusNameRelationHsnmByXiaoK("outSource");
					if (object != null) {
	...
	private JButton getBtnProductNo() {
		if (btnProductNo == null) {
			...
			.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					Object object = CasQuery.getInstance().findMPWorkOrder();
					if (object != null) {
						tfProductNo
								.setText((String) ((TempObject) object)
										.getObject());
