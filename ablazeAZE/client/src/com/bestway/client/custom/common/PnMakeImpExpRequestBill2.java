 ...
 */
public class PnMakeImpExpRequestBill2 extends JPanelBase {

    private PnMakeImpExpRequestBill2 pnMakeCustomsEnvelopBill2 = null;
     ...
     */
    public PnMakeImpExpRequestBill2() {
        super();
        initialize();
     ...
     */
    public PnMakeImpExpRequestBill2 getPnMakeCustomsEnvelopBill2() {
    ...
    public void setPnMakeCustomsEnvelopBill2(
            PnMakeImpExpRequestBill2 pnMakeCustomsEnvelopBill2) {
    ...
    private void initTable() {
        List list = this.casAction.findBillDetailByParentToIMXP(new Request(
                CommonVars.getCurrUser(),true), this.billMasterList);
        JTableListModelAdapter jTableListModelAdapter = new JTableListModelAdapter() {
            public List InitColumns() {
                ...
                list.add(addColumn("仓库名称", "billDetail.wareSet.name", 80));
                ...
                list.add(addColumn("报关商品规格 ", "billDetail.htSpec", 100));
    ...
    public List getCommodityList() {
        ...
        List list = tableModel.getList();
        List<TempBillDetail> newList = new ArrayList();
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i) instanceof TempBillDetail) {
                TempBillDetail temp = (TempBillDetail) list.get(i);
