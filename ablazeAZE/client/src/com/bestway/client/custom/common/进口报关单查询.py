...
bgdhead[u'境内目的地'] = ctrls['Edit20'].Texts()[0]
bgdhead[u'装货港'] = ctrls['Edit21'].Texts()[0]
bgdhead[u'启运国'] = ctrls['Edit22'].Texts()[0]
bgdhead[u'许可证号'] = ctrls['Edit23'].Texts()[0]
bgdhead[u'纳税单位'] = ctrls['Edit24'].Texts()[0]
bgdhead[u'征税比例'] = ctrls['Edit25'].Texts()[0]
...
bgdhead[u'收货单位2'] = ctrls['Edit33'].Texts()[0]
bgdhead[u'收货单位1'] = ctrls['Edit34'].Texts()[0]
...
bgditem[u'用途'] = ctrls['Edit60'].Texts()[0]
...
for i in range(dlg.ListView3.ItemCount()-1):       
    dlg.ListView3.TypeKeys("{DOWN}")
    time.sleep(0.5)
    bgditem={}
