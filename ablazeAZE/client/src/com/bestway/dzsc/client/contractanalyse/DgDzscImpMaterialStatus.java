 ...
 */
public class DgDzscImpMaterialStatus extends JDialogBase {
	 ...
	 */
	public DgDzscImpMaterialStatus() {
		super();
		initialize();
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (contract == null) {
						JOptionPane.showMessageDialog(
								DgDzscImpMaterialStatus.this, "请选择正在执行的合同",
			...
			jButton1.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (tableModel == null || tableModel.getList().size() <= 0) {
						JOptionPane.showMessageDialog(
								DgDzscImpMaterialStatus.this, "没有数据可打印", "提示",
					...
					parameters.put("companyName", CommonVars.getCurrUser()
							.getCompany().getName());
					parameters.put("reportTitle", "进口料件报关情况表");
		...
		tableModel = new JTableListModel(jTable, list,
				new JTableListModelAdapter() {
					public List InitColumns() {
						...
						list.add(addColumn("发票号", "baseCustomsDeclaration.invoiceCode", 100));
						list.add(addColumn("车牌", "baseCustomsDeclaration.billOfLading", 100));
