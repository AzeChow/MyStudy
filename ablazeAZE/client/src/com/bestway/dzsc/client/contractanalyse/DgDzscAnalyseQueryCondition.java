 ...
 */
public class DgDzscAnalyseQueryCondition extends JDialogBase {
	 ...
	 */
	public DgDzscAnalyseQueryCondition() {
		super();
		initialize();
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(41, 196, 105, 25);
			jButton.setText("确定");
			jButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (cbbCommInfo.getSelectedItem() != null) {
						commCode = ((TempDzscCustomsDeclarCommInfo) cbbCommInfo
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setBounds(228, 196, 111, 25);
			jButton1.setText("取消");
