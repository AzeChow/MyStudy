 ...
 */
public class DgDzscCustomsBom extends JDialogBase {
	...
	private DzscCustomsBomDetail bom = null;
	...
	public void setVisible(boolean b) {
		if (b) {
			if (tableModel.getCurrentRow() != null) {
				bom = (DzscCustomsBomDetail) tableModel.getCurrentRow();
				showData();
				setState();
			}
		}
	...
	private void showData() {
		bom = (DzscCustomsBomDetail) tableModel.getCurrentRow();
		this.tfExgSeqNum
				.setText(bom.getDzscCustomsBomExg().getTenSeqNum() == null ? ""
						: bom.getDzscCustomsBomExg().getTenSeqNum().toString());
		this.tfExgName.setText(bom.getDzscCustomsBomExg().getName());
		this.tfExgUnit
				.setText(bom.getDzscCustomsBomExg().getUnit() == null ? ""
						: bom.getDzscCustomsBomExg().getUnit().getName());
		...
		if (btnOk == null) {
			...
			btnOk.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (tfWare.getValue() != null) {
						if (Double.parseDouble(tfWare.getValue().toString()) >= 100) {
							JOptionPane.showMessageDialog(
									DgDzscCustomsBom.this, "损耗不能大于等于100", "提示",
									JOptionPane.INFORMATION_MESSAGE);
							return;
						}
						if (Double.parseDouble(tfWare.getValue().toString()) < 0) {
							JOptionPane.showMessageDialog(
									DgDzscCustomsBom.this, "损耗不能小于0", "提示",
									JOptionPane.INFORMATION_MESSAGE);
							return;
						}
					}
					...
					fillData();
					bom = dzscInnerMergeAction.saveDzscCustomsBomDetail(
			...
			btnPrevious.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (tfWare.getValue() != null) {
						if (Double.parseDouble(tfWare.getValue().toString()) >= 100) {
							JOptionPane.showMessageDialog(
									DgDzscCustomsBom.this, "损耗不能大于等于1", "提示",
									JOptionPane.INFORMATION_MESSAGE);
							return;
						}
						if (Double.parseDouble(tfWare.getValue().toString()) < 0) {
