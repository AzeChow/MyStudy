...
public class DgDzscCustomInnerMerge extends JDialogBase {
    ...
    private JButton              btnDzscCustomInnerMerge  = null;
                ...
                new ListSelectionListener() {
                    public void valueChanged(ListSelectionEvent e) {
                        ...
                        if (tableModel.getCurrentRow() != null) {
                            showData((DzscCustomInnerMergeCondition) tableModel
                                    .getCurrentRow());
                        }
                    }
                });
        jScrollPane.setViewportView(jTable);
        dataSource = dzscInnerMergeAction
                .findDzscCustomInnerMergeCondition(new Request(CommonVars
                        .getCurrUser()));
    ...
    private void editData() {
        ...
        if (tableModel.getCurrentRow() != null) {
            DzscCustomInnerMergeCondition data = (DzscCustomInnerMergeCondition) tableModel
                    .getCurrentRow();
            showData(data);
        ...
        if (btnDelete == null) {
            ...
            btnDelete.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    if (tableModel.getCurrentRow() != null) {
                        if (JOptionPane
                                .showConfirmDialog(DgDzscCustomInnerMerge.this,
                                        "是否确定删除数据!!!", "提示", 0) != 0) {
                            return;
                        }
                        dzscInnerMergeAction.deleteDzscCustomInnerMergeCondition(
                                new Request(CommonVars.getCurrUser()),
                                (DzscCustomInnerMergeCondition) tableModel
                                        .getCurrentRow());
    ...
    private JButton getBtnCustomInnerMerge() {
        if (btnDzscCustomInnerMerge == null) {
            btnDzscCustomInnerMerge = new JButton();
            btnDzscCustomInnerMerge.setText("开始归并");
            btnDzscCustomInnerMerge
                    .addActionListener(new java.awt.event.ActionListener() {
                        public void actionPerformed(java.awt.event.ActionEvent e) {
                            new CustomInnerMergeDataThread().start();
                            if(DgDzscCustomInnerMerge.this.jTable.getRowCount() > 0){
                                DgDzscCustomInnerMerge.this.isBeginCustomInnerOk = true;
                            }
                        }
                    });
        }
        return btnDzscCustomInnerMerge;
    }

    class CustomInnerMergeDataThread extends Thread {
        public void run() {
            try {
                DgDzscCustomInnerMerge.this.btnDzscCustomInnerMerge.setEnabled(false);
                CommonProgress.showProgressDialog(DgDzscCustomInnerMerge.this);
                CommonProgress.setMessage("正在归并数据,请稍候...");
                try {
                    DgDzscCustomInnerMerge.this.dzscInnerMergeAction
                            .dzscCustomInnerMerge(new Request(CommonVars
                                    .getCurrUser()));                    
                ...
                DgDzscCustomInnerMerge.this.btnDzscCustomInnerMerge.setEnabled(true);
            }
        }
    }
    ...
    private JButton getBtnClose() {
        if (btnClose == null) {
            ...
            btnClose.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    DgDzscCustomInnerMerge.this.dispose();
                }
            });
        }
        return btnClose;
    ...
    private void fillData(DzscCustomInnerMergeCondition data) {
        data
    ...
    private void showData(DzscCustomInnerMergeCondition data) {
    ...
    private void saveData() {
        if (dataState == DataState.ADD) {
            DzscCustomInnerMergeCondition data = new DzscCustomInnerMergeCondition();
            fillData(data);
            dzscInnerMergeAction.saveDzscCustomInnerMergeCondition(new Request(
