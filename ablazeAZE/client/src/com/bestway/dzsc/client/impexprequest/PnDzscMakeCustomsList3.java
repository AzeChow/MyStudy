 ...
 */
public class PnDzscMakeCustomsList3 extends JPanelBase {
	private PnDzscMakeCustomsList3 pnMakeCustomsEnvelopBill2 = null;
	 ...
	 */
	public PnDzscMakeCustomsList3 getPnMakeCustomsEnvelopBill2() {
	...
	public void setPnMakeCustomsEnvelopBill2(
			PnDzscMakeCustomsList3 pnMakeCustomsEnvelopBill2) {
	...
	private JButton getBtnSelectAll() {
		if (btnSelectAll == null) {
			...
			btnSelectAll.setBounds(473, 11, 61, 21);
	...
	private void initTable() {
		TempImpExpCommodityInfo TempImpExpCommodityInfos=null;
		List list = this.encAction.findTempImpExpCommodityInfoByParent(
				new Request(CommonVars.getCurrUser()), this.parentList);
		JTableListModelAdapter jTableListModelAdapter = new JTableListModelAdapter() {
			public List InitColumns() {
              ...
              list.add(addColumn("仓库名称", "impExpCommodityInfo.impExpRequestBill.wareSet.name",
              100));
	...
	private boolean checkValue(JTable table, int row, int column) {
		...
		TempImpExpCommodityInfo data = (TempImpExpCommodityInfo) tableModel
				.getDataByRow(row);
