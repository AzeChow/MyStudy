 ...
 */
public class PnDzscMakeCustomsList2 extends JPanelBase {

    private PnDzscMakeCustomsList2 pnMakeCustomsEnvelopBill2 = null;
     ...
     */
    public PnDzscMakeCustomsList2 getPnMakeCustomsEnvelopBill2() {
    ...
    public void setPnMakeCustomsEnvelopBill2(
            PnDzscMakeCustomsList2 pnMakeCustomsEnvelopBill2) {
        ...
        if (btnSelectAll == null) {
            ...
            btnSelectAll.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    PnDzscMakeCustomsList2.this.setCursor(new Cursor(
                            Cursor.WAIT_CURSOR));
                    selectAll(true);
                    PnDzscMakeCustomsList2.this.setCursor(new Cursor(
...
//                        100));
	...
	private JComboBox getJComboBox() {
		if (jComboBox == null) {
			...
			jComboBox.setBounds(115, 11, 125, 21);
			jComboBox.setVisible(false);
			jComboBox.addActionListener(new java.awt.event.ActionListener() { 
				public void actionPerformed(ActionEvent e) {    
					
					if (jComboBox.getSelectedItem() == null || jComboBox.getSelectedItem().equals("") || isexe == false){
						return;
					}
					...
					for (int i = list.size() - 1; i >= 0; i--){
						TempImpExpRequestBill temp = (TempImpExpRequestBill) list.get(i);
			    		if (temp.getImpExpRequestBill() != null && !temp.getImpExpRequestBill().getBillNo().equals(billNo)){
			    			temp.setIsSelected(new Boolean(false));
			    			list.remove(i);
			    		} else if (temp.getImpExpRequestBill() != null && temp.getImpExpRequestBill().getBillNo().equals(billNo)){
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(374, 13, 94, 21);
