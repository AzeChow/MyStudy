 ...
 */
public class DgDzscEmsPorWjImg extends JDialogBase {
	...
	public void setVisible(boolean b) {
		if (b) {
			if (tableModel != null && tableModel.getCurrentRow() != null) {
				img = (DzscEmsImgWj) tableModel.getCurrentRow();
				initUI();
				showData();
			}
		}
	...
	private void showData() {
		...
		tfFourSeqNum.setText(String.valueOf(img.getFourSeqNum()));
		this.tfComplex.setText(img.getFourComplex());
		tfFourName.setText(img.getFourName());
		tfFourSpec.setText(img.getFourSpec());
		this.cbbUnit.setSelectedItem(img.getFourUnit());
		this.cbbFirstUnit.setSelectedItem(img.getFirstUnit());
		this.cbbSecondUnit.setSelectedItem(img.getSecondUnit());
	}
	...
	private javax.swing.JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel121.setBounds(new Rectangle(39, 22, 58, 22));
			jLabel121.setText("备案序号");
			jLabel121.setForeground(Color.blue);
			jLabel1 = new JLabel();
			jLabel1.setBounds(new Rectangle(39, 51, 54, 22));
			...
			jLabel2.setBounds(39, 78, 62, 21);
			jLabel2.setText("商品名称");
			jLabel2.setForeground(Color.blue);
			jLabel3.setBounds(39, 105, 57, 21);
			jLabel3.setText("型号规格");
			jLabel7.setBounds(176, 136, 79, 22);
			jLabel7.setText("第一法定单位");
			jLabel7.setForeground(Color.blue);
			jLabel8.setBounds(39, 135, 31, 20);
			jLabel8.setForeground(Color.blue);
			jLabel8.setText("单位");
			jLabel11.setBounds(39, 168, 75, 23);
			jLabel11.setText("第二法定单位");
			jLabel11.setForeground(Color.black);
			jLabel12.setBounds(214, 22, 57, 22);
			// jLabel12.setForeground(Color.blue);
			jLabel12.setText("归并序号");
			jLabel14.setBounds(194, 194, 131, 20);
	...
	private JTextField getTfFourName() {
		if (tfFourName == null) {
			...
			tfFourName.setBounds(101, 79, 253, 22);
		}
		return tfFourName;
	}
	...
	private JTextField getTfFourSpec() {
		if (tfFourSpec == null) {
			...
			tfFourSpec.setBounds(101, 106, 253, 22);
		}
		return tfFourSpec;
	}
	...
	private JComboBox getCbbFirstUnit() {
		if (cbbFirstUnit == null) {
			...
			cbbFirstUnit.setBounds(255, 137, 100, 23);
		}
		return cbbFirstUnit;
	}
	...
	private JComboBox getCbbSecondUnit() {
		if (cbbSecondUnit == null) {
			...
			cbbSecondUnit.setBounds(116, 168, 114, 22);
		}
	...
	private JTextField getTfFourSeqNum() {
		if (tfFourSeqNum == null) {
			...
			tfFourSeqNum.setBounds(276, 22, 75, 22);
		}
		return tfFourSeqNum;
	}
		...
		if (btnOK == null) {
			...
			btnOK.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					fillData(img);
					img = dzscAction.saveDzscEmsImgWj(new Request(CommonVars
							.getCurrUser()), img);
					tableModel.updateRow(img);
					DgDzscEmsPorWjImg.this.dispose();
				}
			});
		}
		return btnOK;
	...
	private void fillData(DzscEmsImgWj exg) {
	...
	private JTextField getTfComplex() {
		if (tfComplex == null) {
			...
			tfComplex.setBounds(new Rectangle(101, 51, 230, 22));
		}
		return tfComplex;
	}
	...
	private JButton getBtnComplex() {
		if (btnComplex == null) {
			...
			btnComplex.setBounds(new Rectangle(330, 51, 22, 21));
			btnComplex.setText("...");
			btnComplex.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (complex != null) {
						...
						DzscEmsImgWj img = (DzscEmsImgWj) tableModel
								.getCurrentRow();
	...
	private JComboBox getCbbUnit() {
		if (cbbUnit == null) {
			...
			cbbUnit.setBounds(new Rectangle(74, 135, 100, 22));
		}
		return cbbUnit;
	}
	...
	private JTextField getTfSeqNum() {
		if (tfSeqNum == null) {
			...
			tfSeqNum.setBounds(new Rectangle(101, 22, 107, 22));
