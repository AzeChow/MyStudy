...
public class DgDzscEmsPorBillIEPort extends JDialogBase {
	...
	private void showData(){
		if(this.dzscEmsPorHead!=null){
			this.cbbIEPort1.setSelectedItem(this.dzscEmsPorHead.getIePort1());
			this.cbbIEPort2.setSelectedItem(this.dzscEmsPorHead.getIePort2());
			this.cbbIEPort3.setSelectedItem(this.dzscEmsPorHead.getIePort3());
			this.cbbIEPort4.setSelectedItem(this.dzscEmsPorHead.getIePort4());
			this.cbbIEPort5.setSelectedItem(this.dzscEmsPorHead.getIePort5());
			this.cbbIEPort6.setSelectedItem(this.dzscEmsPorHead.getIePort6());
			this.cbbIEPort7.setSelectedItem(this.dzscEmsPorHead.getIePort7());
			this.cbbIEPort8.setSelectedItem(this.dzscEmsPorHead.getIePort8());
			this.cbbIEPort9.setSelectedItem(this.dzscEmsPorHead.getIePort9());
			this.cbbIEPort10.setSelectedItem(this.dzscEmsPorHead.getIePort10());
		}else{
	...
	public void fillData(){
		if(this.dzscEmsPorHead!=null){
			this.dzscEmsPorHead.setIePort1((Customs)this.cbbIEPort1.getSelectedItem());
			this.dzscEmsPorHead.setIePort2((Customs)this.cbbIEPort2.getSelectedItem());
			this.dzscEmsPorHead.setIePort3((Customs)this.cbbIEPort3.getSelectedItem());
			this.dzscEmsPorHead.setIePort4((Customs)this.cbbIEPort4.getSelectedItem());
			this.dzscEmsPorHead.setIePort5((Customs)this.cbbIEPort5.getSelectedItem());
			this.dzscEmsPorHead.setIePort6((Customs)this.cbbIEPort6.getSelectedItem());
			this.dzscEmsPorHead.setIePort7((Customs)this.cbbIEPort7.getSelectedItem());
			this.dzscEmsPorHead.setIePort8((Customs)this.cbbIEPort8.getSelectedItem());
			this.dzscEmsPorHead.setIePort9((Customs)this.cbbIEPort9.getSelectedItem());
			this.dzscEmsPorHead.setIePort10((Customs)this.cbbIEPort10.getSelectedItem());
		}
	}
		...
		if (btnOK == null) {
			...
			btnOK.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					fillData();
					dzscAction.saveDzscEmsPorHead(new Request(CommonVars
