...
public class DgDzscAutoImpEmsBomFromFactoryBom extends JDialogBase {
	 ...
	 * 
	 */
	public DgDzscAutoImpEmsBomFromFactoryBom() {
		super();
		initialize();
						...
						public void actionPerformed(java.awt.event.ActionEvent e) {
							...
							if (tableModelExg == null
								...
								JOptionPane.showMessageDialog(
										DgDzscAutoImpEmsBomFromFactoryBom.this,
										"没有成品资料,所以不能计算单耗", "提示",
							...
							List list = dzscAction
									.autoCalDzscEmsBomUnitWaste(new Request(
			...
			btnConfirm.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (tableModelBomBill == null
						...
						JOptionPane.showMessageDialog(
								DgDzscAutoImpEmsBomFromFactoryBom.this, "当前成品没有单耗资料",
								"提示", JOptionPane.INFORMATION_MESSAGE);
						return;
					}
					List list = tableModelBomBill.getList();
					dzscAction.saveAutoCalDzscEmsBomUnitWaste(new Request(
							CommonVars.getCurrUser(), true), list, exgBill);
					dispose();
				}
			});
		}
		...
		tableModelBomBill = new JTableListModel(tbUnitWaste, list,
				new JTableListModelAdapter() {
					public List InitColumns() {
						...
						list.add(addColumn("合同序号", "seqNum", 50));
						list.add(addColumn("料件总表序号", "imgSeqNum", 120));
						return list;
					}
				});
	}
