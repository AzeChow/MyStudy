 ...
 */
public class DgDzscImpMaterialList extends JDialogBase {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (tableModel == null || tableModel.getList().size() < 1) {
						JOptionPane.showMessageDialog(
								DgDzscImpMaterialList.this, "没有数据可以打印", "提示",
		...
		tableModel = new JTableListModel(jTable, list,
				new JTableListModelAdapter() {
					public List InitColumns() {
						...
						list.add(addColumn("原产国", "country.name", 100));//14
						...
						list.add(addColumn("发票号", "baseCustomsDeclaration.invoiceCode", 100));//25
						list.add(addColumn("车牌号", "baseCustomsDeclaration.billOfLading", 100));//26
