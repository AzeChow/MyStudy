 ...
 */
public class PnDzscMakeListParam extends JPanelBase {
	...
	private void initialize() {
		...
		this.add(getTfBillOfLading(), null);
	...
	private JTextField getTfBillOfLading() {
		if (tfBillOfLading == null) {
			...
			tfBillOfLading.setBounds(113, 140, 127, 21);
		}
	...
	private void fillData() {
		...
		this.makeCusomsDeclarationParam.setDelcarationDate(this.cbbImpExpDate
				.getDate());
		
		this.makeCusomsDeclarationParam.setBillOfLading(this.tfBillOfLading
				.getText().trim());
