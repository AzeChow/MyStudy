 ...
 */
public class FmDzscImportCustomsDeclaration extends
	 ...
	 * 
	 */
	public FmDzscImportCustomsDeclaration() {
		super();
	...
	protected void showCustomsDeclarationData(int dataState) {
		...
		if (contract.getEmsNo() == null
			...
			JOptionPane.showMessageDialog(FmDzscImportCustomsDeclaration.this,
					"电子帐册的编号不能为空", "提示", 0);
			return;
		}
...
} // @jve:decl-index=0:visual-constraint="-117,240"
