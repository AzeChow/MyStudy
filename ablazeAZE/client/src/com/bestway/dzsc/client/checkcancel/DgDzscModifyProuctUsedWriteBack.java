...
public class DgDzscModifyProuctUsedWriteBack extends JDialogBase {
	...
	private DzscContractImgCav imgCav = null;
	...
	public DzscContractImgCav getImgCav() {
		return imgCav;
	}

	public void setImgCav(DzscContractImgCav imgCav) {
		this.imgCav = imgCav;
	}
	 ...
	 * 
	 */
	public DgDzscModifyProuctUsedWriteBack() {
		super();
		initialize();
	...
	private void initTable() {
		...
		if (imgCav != null) {
			list = contractCavAction.findContractBomCavByImgSeqNum(new Request(
					...
					imgCav.getSeqNum() == null ? "" : imgCav.getSeqNum()
							.toString());
		}
		JTableListModelAdapter jTableListModelAdapter = new JTableListModelAdapter() {
			public List InitColumns() {
				...
				list.add(addColumn("成品序号", "seqProductNum", 50, Integer.class));
	...
	class CheckBoxEditor extends DefaultCellEditor implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (obj instanceof DzscContractBomCav) {
				DzscContractBomCav temp = (DzscContractBomCav) obj;
