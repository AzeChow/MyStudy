 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DgByPtQuery extends JDialogBase {
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(84, 66, 67, 23);
			jButton.setText("确定");
			jButton.addActionListener(new java.awt.event.ActionListener() { 

				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (jTextField.getText().equals("")){
						DgByPtQuery.this.setOk(false);
						DgByPtQuery.this.dispose();	
					}
					getResult();
					DgByPtQuery.this.setOk(true);
					DgByPtQuery.this.dispose();	
				}
			});
	...
	{		
		DgByPtQuery.this.setDValue(jTextField.getText().trim());
	}
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setBounds(192, 66, 65, 23);
			jButton1.setText("取消");
	...
	private JTextField getJTextField() {
		if (jTextField == null) {
			...
			jTextField.setBounds(95, 25, 203, 22);
		}
		return jTextField;
	}
