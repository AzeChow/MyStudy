 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DgEmsBySeqNum extends JDialogBase {
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(67, 66, 67, 23);
			jButton.setText("确定");
			jButton.addActionListener(new java.awt.event.ActionListener() { 

				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (jTextField.getText().equals("")){
						DgEmsBySeqNum.this.setOk(false);
						DgEmsBySeqNum.this.dispose();	
					}
					getResult();
					DgEmsBySeqNum.this.setOk(true);
					DgEmsBySeqNum.this.dispose();	
				}
			});
	...
	{		
		DgEmsBySeqNum.this.setDValue(jTextField.getText().trim());
	}
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setBounds(155, 67, 65, 23);
			jButton1.setText("取消");
	...
	private JTextField getJTextField() {
		if (jTextField == null) {
			...
			jTextField.setBounds(95, 25, 128, 22);
		}
		return jTextField;
	}
