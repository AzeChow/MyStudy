...
public class DgImpCustomsRecord extends JInternalFrameBase {
...
//				.getApplicationContext().getBean("materialManageAction");
	...
	public void showCus() {
		...
		if(cus.getBaseCustomsDeclaration().getImpExpType()==ImpExpType.BACK_MATERIEL_EXPORT){
	...
	public void showData(Integer seqNum, String customer, String impExpType, Date beginDate,
		...
		list = encAction.findImpExpCommInfoList(new Request(CommonVars
				...
				endDate, null,isDeclaration, isDept, deptCode, isEffect);
		...
		if (jButton1 == null) {
			...
			jButton1.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (tableModel == null) {
						JOptionPane.showMessageDialog(DgImpCustomsRecord.this,
								"没有可打印的记录！", "提示", 2);
						return;
					}
					...
					String sumPrice1 = CommonVars
							.formatDoubleToString(sumPrice); // 总金额
					...
					InputStream masterReportStream = DgImpCustomsRecord.class
							.getResourceAsStream("report/ImpExpCustomsRecord.jasper");
					InputStream detailReportStream = DgImpCustomsRecord.class
					...
					try {
						...
						parameters.put("sumPrice", sumPrice1);// 总金额(美圆金额)
			...
			public List InitColumns() {
				...
				if (lists != null && lists.size() > 0) {
					...
					if (reportControl.getPreCustomsDeclarationCode() != null
							&& reportControl.getPreCustomsDeclarationCode()
									.equals(new Boolean(true))) {
						list
								.add(addColumn(
										"预录入号",
	...
	/**
	 * This method initializes btnRefCustom	
	 * 	
	 * @return javax.swing.JButton	
	 */
	...
	/**
	 * This method initializes btnRefQingDan	
	 * 	
	 * @return javax.swing.JButton	
	 */
		...
		if (btnRefQingDan == null) {
			...
			btnRefQingDan.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					dg.showFromDgImpCustomsRecord(true, cus.getBaseCustomsDeclaration().getCustomsDeclarationCode(), 
							cus.getCommSerialNo() + "");
