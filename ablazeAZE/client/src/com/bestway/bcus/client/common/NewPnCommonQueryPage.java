...
public abstract class NewPnCommonQueryPage extends JPanelBase  {


	public JComboBox cbbQueryField = null;
	private JTextField tfQueryValue = null;
	public JTableListModel tableModel = null;
	public List dataSource = new ArrayList();  //  @jve:decl-index=0:
	...
	private String editBeforeQueryValue = "";  //  @jve:decl-index=0:
	...
	private Long count = 0L;  //  @jve:decl-index=0:
	...
	protected boolean isFirstSeach = true;
	public List newDataSource = new ArrayList();  //  @jve:decl-index=0:
	/**
	 * This method initializes
	 * 
	 */
	public NewPnCommonQueryPage() {
		super();
		initialize();
	...
	public void initCbbQueryField() {
		...
		if (tableModel != null) {
			for (int i = 0; i < tableModel.getColumnCount(); i++) {
				...
				int dataType = getDataTypeByColumns(c.getProperty());
	...
	private void selectItem() {
		...
		if (dataType == DataType.BOOLEAN) {
			...
			cbIsTrue
					.setText(((Item) cbbQueryField.getSelectedItem()).getName());
	...
	private void searchPage(Boolean isDownPage) {
		if (isProgres) {
			System.out.println("FFFFF" + isChange);
			...
			dataSource = this.findMaterielByPara(index, length, item == null ? null
					: item.getProperty(), getValue(), getIsLike());
	...
	public boolean isFirstSeach() {
		return isFirstSeach;
	}

	public void setFirstSeach(boolean isFirstSeach) {
		this.isFirstSeach = isFirstSeach;
	}
}
