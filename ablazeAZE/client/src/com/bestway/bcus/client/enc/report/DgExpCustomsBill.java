 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DgExpCustomsBill extends JInternalFrameBase {
...
//		});
		...
		tableModel = new JTableListModel(jTable, list,
				new JTableListModelAdapter() {
					public List InitColumns() {
						...
						list.add(addColumn("贸易方式", "bill8", 60));
						list.add(addColumn("备注", "bill9", 60));	
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			...
			jLabel2.setText("至");
			jLabel3.setBounds(376, 37, 162, 20);
			jLabel3.setText("帐册号：");
	...
	class find extends Thread{
		...
		public void run(){
			 try {
				...
				lsResult=encAction.jisuanExpCustomsBill(new Request(
						CommonVars.getCurrUser()),beginDate,endDate);
				CommonProgress.closeProgressDialog();
			 } catch (Exception e) {
		        CommonProgress.closeProgressDialog();
		        JOptionPane.showMessageDialog(DgExpCustomsBill.this,
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(375, 65, 75, 24);
			jButton.setText("查询");
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setBounds(457, 65, 75, 24);
			jButton1.setText("关闭");
