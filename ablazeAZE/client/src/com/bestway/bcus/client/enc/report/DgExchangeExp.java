 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DgExchangeExp extends JDialogBase {
		...
		tableModel = new JTableListModel(jTable, list,
				new JTableListModelAdapter() {
					public List InitColumns() {
						...
						list.add(addColumn("备案序号", "bill2", 80));
						...
						list.add(addColumn("出口量", "billSum1", 80));
...
//				boolean iseffect = jCheckBox.isSelected();
				...
				lsResult=encAction.jisuanExchangeExp(new Request(
						CommonVars.getCurrUser()),1,beginDate,endDate);
				CommonProgress.closeProgressDialog();
			 } catch (Exception e) {
		        CommonProgress.closeProgressDialog();
		        JOptionPane.showMessageDialog(DgExchangeExp.this,
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(376, 45, 69, 23);
			jButton.setText("查询");
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setBounds(499, 44, 68, 23);
			jButton1.setText("关闭");
