...
public class DgHalfProductManager extends JDialogBase {
    ...
    class makeThread extends Thread {
        public void run() {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(DgHalfProductManager.this, info,
                        "提示", 2);

            } catch (Exception e) {
                CommonProgress.closeProgressDialog(flag);
                JOptionPane
                        .showMessageDialog(DgHalfProductManager.this,
    ...
    class makeThread1 extends Thread {
        public void run() {
            ...
            try {
                ...
                String info = "半成品委外出库单据(半成品)转成 外发加工出库单据(料件)任务完成!!\n共用时:"
                        + (System.currentTimeMillis() - beginTime) + " 毫秒 ";
                JOptionPane.showMessageDialog(DgHalfProductManager.this, info,
                        "提示", 2);
                ...
                CommonProgress.closeProgressDialog(flag);
                JOptionPane.showMessageDialog(DgHalfProductManager.this,
