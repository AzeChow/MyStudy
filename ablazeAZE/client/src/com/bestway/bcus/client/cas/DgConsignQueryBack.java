 ...
 * 贺巍于2010年 2月6日添加注释
 */
public class DgConsignQueryBack extends JDialogBase {
	...
	private List getTiaojian() {
		...
		if (cbbWareSet.getSelectedItem() != null) {
			tiaojian.add(new Condition("and", null, "wareSet", "=", cbbWareSet
					.getSelectedItem(), null));
		}
	...
	private List getTiaojian2() {
		...
		if (cbbWareSet.getSelectedItem() != null) {
			tiaojian2.add(new Condition("and", null, "wareSet", "=", cbbWareSet
					.getSelectedItem(), null));
		}
			...
			btnPrint.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					try {
						...
						InputStream masterReportStream = DgConsignQueryBack.class
						...
						parameters.put("title", "委外加工收回进出仓帐");
