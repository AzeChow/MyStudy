 ...
 */
public class DgFinanceDebtEdit extends JDialogBase {
	...
	private DebtMaster debtMaster = null;
    ...
    public void setVisible(boolean isFlag){
        if(isFlag){
            debtMaster = (DebtMaster) tableModelMaster.getCurrentRow();
               list = casAction.findDebtDetail(new Request(CommonVars.getCurrUser()),debtMaster);
		...
		tableModel = new JTableListModel(jTable, list,
				new JTableListModelAdapter() {
					public List InitColumns() {
						...
						list.add(addColumn("资产", "item1", 130));
						list.add(addColumn("行次", "times1", 30));
						list.add(addColumn("年初数", "beginValue1", 60));
						list.add(addColumn("期末数", "endValue1", 60));
						
						list.add(addColumn("负债及所有者权益", "item2", 130));
						list.add(addColumn("行次", "times2", 30));
						list.add(addColumn("年初数", "beginValue2", 60));
						list.add(addColumn("期末数", "endValue2", 60));
						return list;
					}
				});
	}
	 ...
	 */
	private void initUI(){
		this.jLabel1.setText(CommonVars.dateToString(debtMaster.getReportDate()));
	}
...
//            jToolBar.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.LOWERED));
		...
		if (jButton == null) {
			...
			jButton.addActionListener(new java.awt.event.ActionListener() { 
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {    
					...
					try{
					  DgFinanceDebtEditEdit dg = new DgFinanceDebtEditEdit();
			...
			jButton1.addActionListener(new java.awt.event.ActionListener() { 
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {    
					...
					if (list !=null && !list.isEmpty()){
				    	...
				    	InputStream masterReportStream = DgFinanceDebtEdit.class
			    			.getResourceAsStream("report/FinanceDebtReport.jasper");			
				    	InputStream detailReportStream = DgFinanceDebtEdit.class
					    	.getResourceAsStream("report/FinanceDebtReportSubb.jasper");
					try {
						...
						String defaultDate = bartDateFormat.format(debtMaster.getReportDate());
		...
		if (jButton2 == null) {
			...
			jButton2.addActionListener(new java.awt.event.ActionListener() { 
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {    
					...
					DgFinanceDebtEdit.this.dispose();
				}
			});
