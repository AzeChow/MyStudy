 ...
 */
public class DgTrusteeInOutBack extends JDialogBase {
	...
	class searchThread extends Thread {
		...
		public void run() {
			...
			try {
				CommonProgress
						.showProgressDialog(flag, DgTrusteeInOutBack.this);
				CommonProgress.setMessage(flag, "系统正获取数据，请稍后...");
				impExpInfos = casAction.getResultWaiFaTrusteeInOutBack(
				...
				CommonProgress.closeProgressDialog(flag);
				JOptionPane.showMessageDialog(DgTrusteeInOutBack.this,
			...
			btnPrint.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					try {
						...
						InputStream masterReportStream = DgTrusteeInOutBack.class
								.getResourceAsStream("report/CustomInoutWareReportWaiFaTrusteeInOutBack.jasper");
						Map<String, Object> parameters = new HashMap<String, Object>();
						// if (materialType == MaterielType.MATERIEL) {
						parameters.put("title", "受托加工返回进出仓帐");
