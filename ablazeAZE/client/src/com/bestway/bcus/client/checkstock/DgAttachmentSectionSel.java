			...
			jButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(section != null){
						...
						ecsCheckStockAction.saveEcsSection(new Request(CommonVars.getCurrUser()), section);
						ecsCheckStockAction.saveECSAttachmentTemplate(new Request(CommonVars.getCurrUser()), section);
	...
	private void loadTable(){
		new AsynSwingWorker<List<ECSSection>>(){
			protected List<ECSSection> submit() {
				return ecsCheckStockAction.findAttachmentSection(new Request(CommonVars.getCurrUser()),false);
			}
