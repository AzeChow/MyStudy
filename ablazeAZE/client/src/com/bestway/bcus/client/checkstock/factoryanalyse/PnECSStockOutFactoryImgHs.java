...
public class PnECSStockOutFactoryImgHs extends JPanel {
	 ...
	 */
	public PnECSStockOutFactoryImgHs(FmECSStockOutFactoryImg parent) {
			super();
			this.parent = parent;
			...
			btnHistroy.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (parent.getSection() == null) {
						JOptionPane.showMessageDialog(PnECSStockOutFactoryImgHs.this, "批次号不能为空！", "警告",
								JOptionPane.WARNING_MESSAGE);
						return;
					}
					PnECSStockOutFactoryImgHs.this.doFindStars();
				}
			});
		}
		return btnHistroy;
...
//				public void actionPerformed(ActionEvent e) {
//					PnECSStockOutFactoryImgHs.this.doConvertStars();
//				}
//			});
//		}
//		return btnCalculate;
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (JOptionPane.YES_NO_OPTION == JOptionPane.showOptionDialog(null, "确定要清空本次批次的数据吗?", "提示",
						...
						try {
							...
							ex.printStackTrace();
							JOptionPane.showMessageDialog(PnECSStockOutFactoryImgHs.this, "未能成功删除！", "警告",
									JOptionPane.WARNING_MESSAGE);
						}finally{
							initBtnStatus(2);
						}
			...
			btnImport.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						DgECSImportHs<ECSStockOutFactoryImg> dgECSImport = new DgECSImportHs<ECSStockOutFactoryImg>(true);
						dgECSImport.setClazz("PnECSStockOutFactoryImgHs");
