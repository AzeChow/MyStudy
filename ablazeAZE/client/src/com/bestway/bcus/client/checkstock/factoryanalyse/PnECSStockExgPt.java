...
public class PnECSStockExgPt extends JPanel {
	 ...
	 */
	public PnECSStockExgPt(FmECSStockExg parent) {
		super();
		this.parent = parent;
			...
			btnHistroy.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (parent.getSection() == null) {
						JOptionPane
								.showMessageDialog(PnECSStockExgPt.this, "批次号不能为空！", "警告", JOptionPane.WARNING_MESSAGE);
						return;
					}
					PnECSStockExgPt.this.doFindStars();
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (JOptionPane.YES_NO_OPTION == JOptionPane.showOptionDialog(null, "确定要清空本次批次的数据吗?", "提示",
						...
						try {
							...
							ex.printStackTrace();
							JOptionPane.showMessageDialog(PnECSStockExgPt.this, "未能成功删除！", "警告",
			...
			btnImport.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						DgECSImportPt<ECSStockExg> dgECSImport = new DgECSImportPt<ECSStockExg>(false);
						dgECSImport.setClazz("PnECSStockExgPt");
		...
		if (btnCalculate == null) {
			...
			btnCalculate.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					tabbedPane.setSelectedIndex(0);
					PnECSStockExgPt.this.doConvertHsExg();					
				}
			});
		}
		return btnCalculate;
		...
		if (btnSwitch == null) {
			...
			btnSwitch.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					PnECSStockExgPt.this.doConvertHsExgTo();
				}
			});
		}
		return btnSwitch;
