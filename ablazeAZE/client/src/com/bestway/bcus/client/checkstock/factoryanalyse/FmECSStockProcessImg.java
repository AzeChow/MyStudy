...
public class FmECSStockProcessImg extends JInternalFrameBase {
	...
	private PnECSStockProccessImgHs pnHs;
	private PnECSStockProccessImgPt pnPt;
	...
	private PnECSStockProccessImgPt getPnPt() {
		if(pnPt == null) {
			pnPt = new PnECSStockProccessImgPt(this);
		}
		
		return pnPt;
	}
	
	private PnECSStockProccessImgHs getPnHs() {
		if(pnHs == null) {
			pnHs = new PnECSStockProccessImgHs(this);
		}
