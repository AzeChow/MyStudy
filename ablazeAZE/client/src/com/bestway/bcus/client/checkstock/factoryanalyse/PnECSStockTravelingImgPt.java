...
public class PnECSStockTravelingImgPt extends JPanel {
	 ...
	 */
	public PnECSStockTravelingImgPt(FmECSStockTravelingImg parent) {
		super();
		this.parent = parent;
			...
			btnHistroy.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (parent.getSection() == null) {
						JOptionPane.showMessageDialog( PnECSStockTravelingImgPt.this, "批次号不能为空！", "警告",
								JOptionPane.WARNING_MESSAGE);
						return;
					}
					PnECSStockTravelingImgPt.this.doFindStars();
					initBtnStatus(2);
				}
			});
		}
	...
	private JButton getBtnCalculate() {
		if (btnCalculate == null) {
			...
			btnCalculate.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					PnECSStockTravelingImgPt.this.doConvertStars();
				}
			});
		}
		return btnCalculate;
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (JOptionPane.YES_NO_OPTION == JOptionPane.showOptionDialog(null, "确定要清空本次批次的数据吗?", "提示",
						...
						try {
							...
							ex.printStackTrace();
							JOptionPane.showMessageDialog(PnECSStockTravelingImgPt.this, "未能成功删除！", "警告",
									JOptionPane.WARNING_MESSAGE);
						}
			...
			btnImport.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						DgECSImportPt<ECSStockTravelingImg> dgECSImport = new DgECSImportPt<ECSStockTravelingImg>(true);
						dgECSImport.setSection(parent.getSection());
						dgECSImport.setClazz("PnECSStockTravelingImgPt");
