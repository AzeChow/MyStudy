...
public class PnECSStockTravelingExgHs extends JPanel {
	/**
	 * 
	 */
	...
	private FmECSStockTravelingExg parent;
	 ...
	 */
	public PnECSStockTravelingExgHs(FmECSStockTravelingExg parent) {
		super();
		this.parent = parent;
			...
			btnHistroy.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (parent.getSection() == null) {
						JOptionPane
								.showMessageDialog(PnECSStockTravelingExgHs.this, "批次号不能为空！", "警告", JOptionPane.WARNING_MESSAGE);
						return;
					}
					PnECSStockTravelingExgHs.this.doFindStars();
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (JOptionPane.YES_NO_OPTION == JOptionPane.showOptionDialog(null, "确定要清空本次批次的数据吗?", "提示",
						...
						try {
							...
							ex.printStackTrace();
							JOptionPane.showMessageDialog(PnECSStockTravelingExgHs.this, "未能成功删除！", "警告",
			...
			btnImport.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						DgECSImportHs<ECSStockTravelingExg> dgECSImport = new DgECSImportHs<ECSStockTravelingExg>(false);
						dgECSImport.setSection(parent.getSection());
						dgECSImport.setClazz("PnECSStockTravelingExgHs");
		...
		if (btnSwitch == null) {
			...
			btnSwitch.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					tabbedPane.setSelectedIndex(1);
					PnECSStockTravelingExgHs.this.doConvertHsExgTo();
				}
			});
		}
		return btnSwitch;
