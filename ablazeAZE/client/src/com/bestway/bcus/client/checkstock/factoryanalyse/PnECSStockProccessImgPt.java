...
public class PnECSStockProccessImgPt extends JPanel {
	 ...
	 */
	public PnECSStockProccessImgPt(FmECSStockProcessImg parent) {
		super();
		this.parent = parent;
			...
			btnHistroy.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (parent.getSection() == null) {
						JOptionPane.showMessageDialog(PnECSStockProccessImgPt.this, "批次号不能为空！", "警告",
								JOptionPane.WARNING_MESSAGE);
					} else {
						PnECSStockProccessImgPt.this.doFindStars();
						initBtnStatus(2);
					}
				}
			});
	...
	private JButton getBtnCalculate() {
		if (btnCalculate == null) {
			...
			btnCalculate.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					PnECSStockProccessImgPt.this.doConvertStars();
				}
			});
		}
		return btnCalculate;
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (JOptionPane.YES_NO_OPTION == JOptionPane.showOptionDialog(null, "确定要清空本次批次的数据吗?", "提示",
						...
						try {
							...
							ex.printStackTrace();
							JOptionPane.showMessageDialog(PnECSStockProccessImgPt.this, "未能成功删除！", "警告",
									JOptionPane.WARNING_MESSAGE);
						}
			...
			btnImport.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						DgECSImportPt<ECSStockProcessImg> dgECSImport = new DgECSImportPt<ECSStockProcessImg>(true);
						dgECSImport.setClazz("PnECSStockProcessImgPt");
