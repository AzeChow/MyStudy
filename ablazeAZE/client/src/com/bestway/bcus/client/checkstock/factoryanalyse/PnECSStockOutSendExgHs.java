...
public class PnECSStockOutSendExgHs extends JPanel {
	 ...
	 */
	public PnECSStockOutSendExgHs(FmECSStockOutSendExg parent) {
		super();
		this.parent = parent;
			...
			btnHistroy.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (parent.getSection() == null) {
						JOptionPane.showMessageDialog(PnECSStockOutSendExgHs.this, "批次号不能为空！", "警告",
								JOptionPane.WARNING_MESSAGE);
						return;
					}
					PnECSStockOutSendExgHs.this.doFindStars();					
				}
			});
		}
		return btnHistroy;
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (JOptionPane.YES_NO_OPTION == JOptionPane.showOptionDialog(null, "确定要清空本次批次的数据吗?", "提示",
						...
						try {
							...
							ex.printStackTrace();
							JOptionPane.showMessageDialog(PnECSStockOutSendExgHs.this, "删除失败！", "警告",
									JOptionPane.WARNING_MESSAGE);
						}
			...
			btnImport.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						DgECSImportHs<ECSStockOutSendExg> dgECSImport = new DgECSImportHs<ECSStockOutSendExg>(false);
						dgECSImport.setClazz("PnECSStockOutSendExgHs");
		...
		if (btnSwitch == null) {
			...
			btnSwitch.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					PnECSStockOutSendExgHs.this.doConvertHsTo();
				}
			});
		}
		return btnSwitch;
