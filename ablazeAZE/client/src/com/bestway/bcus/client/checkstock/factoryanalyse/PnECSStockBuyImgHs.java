...
public class PnECSStockBuyImgHs extends JPanel {
	 ...
	 */
	public PnECSStockBuyImgHs(FmECSStockBuyImg parent) {
		super();
		this.parent = parent;
			...
			btnHistroy.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (parent.getSection() == null) {
						JOptionPane.showMessageDialog(PnECSStockBuyImgHs.this, "批次号不能为空！", "警告",
								JOptionPane.WARNING_MESSAGE);
						return;
					}
					PnECSStockBuyImgHs.this.doFindStars();
					initBtnStatus(2);
				}
			});
		}
...
//				public void actionPerformed(ActionEvent e) {
//					PnECSStockBuyImgHs.this.doConvertStars();
//				}
//			});
//		}
//		return btnCalculate;
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (JOptionPane.YES_NO_OPTION == JOptionPane.showOptionDialog(null, "确定要清空本次批次的数据吗?", "提示",
						...
						try {
							...
							ex.printStackTrace();
							JOptionPane.showMessageDialog(PnECSStockBuyImgHs.this, "未能成功删除！", "警告",
									JOptionPane.WARNING_MESSAGE);
						}
			...
			btnImport.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						DgECSImportHs<ECSStockBuyImg> dgECSImport = new DgECSImportHs<ECSStockBuyImg>(true);
						dgECSImport.setClazz("PnECSStockBuyImgHs");
...
//			btnCalculate.setEnabled(true);
	...
	private JLabel getLabel() {
		if (label == null) {
			label = new JLabel("<html><font color='blue'>【编码级】</font></html>");
			label.setVerticalAlignment(SwingConstants.TOP);
			label.setBounds(723, 5, 99, 21);
		}
		return label;
	}
}
