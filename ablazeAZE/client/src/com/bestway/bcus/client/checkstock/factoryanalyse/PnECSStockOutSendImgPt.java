...
public class PnECSStockOutSendImgPt extends JPanel {
	/**
	 * 
	 */
	 ...
	 */
	public PnECSStockOutSendImgPt(FmECSStockOutSendImg parent) {
		super();
		this.parent = parent;
				...
				public void actionPerformed(ActionEvent e) {
					if (parent.getSection() == null) {
						JOptionPane.showMessageDialog(
								PnECSStockOutSendImgPt.this, "批次号不能为空！", "警告",
								JOptionPane.WARNING_MESSAGE);
						return;
					}
					
					PnECSStockOutSendImgPt.this.doFindStars();					
				}
			});
		}
		return btnHistroy;
		...
		if (btnCalculate == null) {
			...
			btnCalculate.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (parent.getSection() == null) {
						JOptionPane
								.showMessageDialog(PnECSStockOutSendImgPt.this, "批次号不能为空！", "警告", JOptionPane.WARNING_MESSAGE);
						return;
					}
					PnECSStockOutSendImgPt.this.doConvertStars();
				}
			});
		}
		return btnCalculate;
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (JOptionPane.YES_NO_OPTION == JOptionPane.showOptionDialog(null, "确定要清空本次批次的数据吗?", "提示",
						...
						try {
							...
							ex.printStackTrace();
							JOptionPane.showMessageDialog(PnECSStockOutSendImgPt.this, "未能成功删除！", "警告",
									JOptionPane.WARNING_MESSAGE);
						}
			...
			btnImport.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						DgECSImportPt<ECSStockOutSendImg> dgECSImport = new DgECSImportPt<ECSStockOutSendImg>(true);
						dgECSImport.setClazz("PnECSStockOutSendImgPt");
