...
public class FmECSStockBuyImg extends JInternalFrameBase {
	...
	private PnECSStockBuyImgHs pnHs;
	private PnECSStockBuyImgPt pnPt;
	...
	private PnECSStockBuyImgPt getPnPt() {
		if(pnPt == null) {
			pnPt = new PnECSStockBuyImgPt(this);
		}
		
		return pnPt;
	}
	
	private PnECSStockBuyImgHs getPnHs() {
		if(pnHs == null) {
			pnHs = new PnECSStockBuyImgHs(this);
		}
