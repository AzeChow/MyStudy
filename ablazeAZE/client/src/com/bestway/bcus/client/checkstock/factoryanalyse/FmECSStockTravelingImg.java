...
public class FmECSStockTravelingImg extends JInternalFrameBase {
	...
	private PnECSStockTravelingImgHs pnHs;
	private PnECSStockTravelingImgPt pnPt;
	...
	private void initialize() {
		...
		this.setTitle("在途料件库存");
		this.setContentPane(this.getJContentPane());
		this.jContentPane.setLayout(new BorderLayout(0, 0));
		this.jContentPane.add(getPnPt(), BorderLayout.CENTER);
	}
	...
	private PnECSStockTravelingImgPt getPnPt() {
		if(pnPt == null) {
			pnPt = new PnECSStockTravelingImgPt(this);
		}
		
		return pnPt;
	}
	
	private PnECSStockTravelingImgHs getPnHs() {
		if(pnHs == null) {
			pnHs = new PnECSStockTravelingImgHs(this);
		}
