 ...
 */
public class DgPanDImgX extends JDialogBase {
	...
	private EmsPdImgBg img = null; //料件
...
//		jFormattedTextField.setText(doubleToStr(img.getNotProNum()));
		jFormattedTextField1.setText(doubleToStr(img.getTotalNum()));
	}
	/**
	...
	private javax.swing.JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel.setText("序号");
			jLabel.setBounds(14, 23, 67, 18);
			jLabel3.setBounds(14, 49, 74, 17);
			jLabel3.setText("报关品名");
			jLabel4.setBounds(14, 74, 73, 20);
			jLabel4.setText("报关型号规格");
			jLabel10.setBounds(14, 101, 59, 21);
			jLabel10.setText("保税数量");
			jLabel12.setBounds(14, 127, 54, 21);
			jLabel12.setText("总数量");
			jLabel7.setBounds(17, 128, 65, 19);
	...
	private JFormattedTextField getJFormattedTextField3() {
		if (jFormattedTextField3 == null) {
			...
			jFormattedTextField3.setBounds(89, 101, 116, 22);
			...
			jButton.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					img = checkCancelAction
							.SaveEmsPdImgBg(new Request(CommonVars
									.getCurrUser()), img);
					tableModel.updateRow(img);
					DgPanDImgX.this.dispose();
				}
			});
...
//		img.setNotProNum(strToDouble(jFormattedTextField.getText()));
	...
	private JFormattedTextField getJFormattedTextField() {
		if (jFormattedTextField == null) {
			...
			jFormattedTextField.setBounds(89, 128, 116, 22);
	...
	private JFormattedTextField getJFormattedTextField1() {
		if (jFormattedTextField1 == null) {
			...
			jFormattedTextField1.setBounds(181, 133, 116, 22);
