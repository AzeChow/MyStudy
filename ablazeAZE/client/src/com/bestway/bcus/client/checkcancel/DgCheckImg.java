 ...
 */
public class DgCheckImg extends JDialogBase {
	...
	private CheckImg checkImg = null; //料件
	...
	private void fillWindowImg() {
		...
		jTextField1.setText(checkImg.getPtNo());
		jTextField3.setText(checkImg.getName());
		jTextField2.setText(checkImg.getComplex()==null?"":checkImg.getComplex().getCode());
		jTextField4.setText(checkImg.getSpec());
		jTextField6.setText(checkImg.getUnit()== null?"":checkImg.getUnit().getName());
		...
		jFormattedTextField5.setText(doubleToStr(checkImg.getThisMaterInWare()));
		jFormattedTextField13.setText(doubleToStr(checkImg.getMaterGet()));
		jFormattedTextField6.setText(doubleToStr(checkImg.getThisMaterCancel()));
		...
		jFormattedTextField10.setText(doubleToStr(checkImg.getMaterExitChange()));
		jFormattedTextField11.setText(doubleToStr(checkImg.getHalfExgConvert()));
		jFormattedTextField12.setText(doubleToStr(checkImg.getThisThrowRemainExg()));
	}
	/**
	...
	private javax.swing.JPanel getJContentPane() {
		if (jContentPane == null) {
			jLabel23 = new JLabel();
			jLabel23.setBounds(new java.awt.Rectangle(50,288,334,23));
			jLabel23.setForeground(java.awt.Color.red);
			jLabel23.setText("其他原料数量（在线数量，废品,残次品折料数量，废料数量）");
			jLabel22 = new JLabel();
			jLabel22.setBounds(new java.awt.Rectangle(14,267,545,27));
			jLabel22.setForeground(java.awt.Color.red);
			jLabel22.setText("注明：企业实际库存 = 原料库存数量 + 原料在途数量 + 成品折料数量 + 其他原料数量 - 转进未报数量 ");
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(199, 322, 70, 25);
			jButton.setText("确定");
	...
	public void fillDataImg(CheckImg checkImg) { //保存
		...
		checkImg.setThisMaterInWare(strToDouble(jFormattedTextField5.getText()));
		checkImg.setMaterGet(strToDouble(jFormattedTextField13.getText()));
		checkImg.setThisMaterCancel(strToDouble(jFormattedTextField6.getText()));
		...
		checkImg.setMaterExitChange(strToDouble(jFormattedTextField10.getText()));
		checkImg.setHalfExgConvert(strToDouble(jFormattedTextField11.getText()));
		checkImg.setThisThrowRemainExg(strToDouble(jFormattedTextField12.getText())); 
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setBounds(306, 322, 69, 25);
			jButton1.setText("取消");
