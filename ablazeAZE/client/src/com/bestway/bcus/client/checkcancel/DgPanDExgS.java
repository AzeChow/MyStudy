 ...
 */
public class DgPanDExgS extends JDialogBase {
	...
	private void fillWindowImg() {
		...
		jTextField.setText(img.getWorkBillNo());
		jTextField2.setText(img.getVersionNo());
			...
			jButton.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					img = checkCancelAction
							.SaveEmsPdExg(new Request(CommonVars
									.getCurrUser()), img);
					tableModel.updateRow(img);
					DgPanDExgS.this.dispose();
				}
			});
	...
	public void fillDataImg(EmsPdExg img) { //保存
		img.setWorkBillNo(jTextField.getText());
		img.setVersionNo(jTextField2.getText());
	...
	private JTextField getJTextField() {
		if (jTextField == null) {
			...
			jTextField.setBounds(88, 102, 66, 22);
		}
		return jTextField;
	}
	/**
	...
	private JTextField getJTextField2() {
		if (jTextField2 == null) {
			...
			jTextField2.setBounds(206, 102, 83, 22);
		}
		return jTextField2;
	}
