 ...
 */
package com.bestway.bcus.client.innermerge.report;
...
public class InnerMergeScriptlet extends JRDefaultScriptlet{
	...
	public void afterDetailEval() throws JRScriptletException {
		this.setVariableValue("tempAfterTenNo",this.getFieldValue("hsAfterTenMemoNo"));
		this.setVariableValue("tempFourNo",this.getFieldValue("hsFourNo"));
	}
}
