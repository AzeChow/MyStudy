...
public class DgAutoInnerMergeParam  extends JDialogBase {
	...
	private TempAutoInnerMergeParam autoInnerMergeParam = null;

	public boolean isOK() {
		return isOK;
	}

	public TempAutoInnerMergeParam getAutoInnerMergeParam() {
		return autoInnerMergeParam;
	}

	public void setAutoInnerMergeParam(TempAutoInnerMergeParam innerMergeParam) {
		this.autoInnerMergeParam = innerMergeParam;
	}

	public DgAutoInnerMergeParam() {
		super();
		initialize();
	}

	public DgAutoInnerMergeParam(boolean isModal) {
		super(isModal);
		initialize();
	}

	public DgAutoInnerMergeParam(JFrame owner, boolean isModal) {
		super(owner, isModal);
		initialize();
	}

	public DgAutoInnerMergeParam(Dialog owner, boolean isModal) {
		super(owner, isModal);
		initialize();
	}
		...
		if (jButton == null) {
			...
			jButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					isOK=true;
					autoInnerMergeParam=new TempAutoInnerMergeParam();
