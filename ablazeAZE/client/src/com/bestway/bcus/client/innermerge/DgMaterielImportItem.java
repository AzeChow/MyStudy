 ...
 */
public class DgMaterielImportItem extends JDialogBase {
        ...
        if (btnOk == null) {
            ...
            btnOk.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    setOk(true);
                    DgMaterielImportItem.this.dispose();
                }
            });
        }
        return btnOk;
    ...
    private void fillJList() {
        ...
        vector.add(checkableItem);
        checkableItem = new CheckableItem(MaterielType.REMAIN_MATERIEL, "边角料");
        vector.add(checkableItem);
