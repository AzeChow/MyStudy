...
public class DgJDBCView extends JDialogBase {
			...
			btnAdd.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(jdbcDataSource == null){
						JOptionPane.showMessageDialog(DgJDBCView.this,
								"请选择数据源", "确认", 2);
						return;
					}
					DgJDBCViewEdit dg = new DgJDBCViewEdit();
	...
	private JButton getBtnEdit() {
		if (btnEdit == null) {
			...
			btnEdit.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					JDBCView jdbcView = (JDBCView)tableModel.getCurrentRow();
					if (jdbcView == null) {
						JOptionPane.showMessageDialog(DgJDBCView.this,
								"请选择你要修改的资料", "确认", 2);
						return;
					...
					dg.setTableModel(tableModel);
					dg.setJdbcDataSource(jdbcView.getJdbcDataSource());
					dg.setVisible(true);
				}
			});
	...
	private JButton getBtnDelete() {
		if (btnDelete == null) {
			...
			btnDelete.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (JOptionPane.showConfirmDialog(DgJDBCView.this,
							"确定删除吗?", "提示", 0) == 0) {
						...
						JDBCView obj = (JDBCView) tableModel
								.getCurrentRow();
						try {
							dataExportAction.deleteJDBCView(new Request(
		...
		tableModel = new JTableListModel(jTable, dataSource,
				new JTableListModelAdapter() {
					...
					public List<JTableListColumn> InitColumns() {
						...
						list.add(addColumn("SQL 脚本", "sqlScript", 380));
						return list;
					}
				});
	}
			...
			jList
					.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
						...
						public void valueChanged(
							...
							List list = dataExportAction.findJDBCView(new Request(CommonVars
