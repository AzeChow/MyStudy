 ...
 */
public class PnMakeListParam extends JPanelBase {
...
//	}
	 ...
	 */
	public PnMakeListParam(ScmCoc scmCoc) {
		super();
		initialize();
		this.scmCoc=scmCoc;
	...
	private JCalendarComboBox getCbbDeclarationDate() {
		if (cbbDeclarationDate == null) {
			...
			cbbDeclarationDate.setBounds(356, 25, 112, 21);
		}
	...
	private void showInitData(){
		if(scmCoc!=null){
			this.cbbCountryOfLoadingOrUnloading.setSelectedItem(scmCoc.getCountry());
			this.cbbPortOfLoadingOrUnloading.setSelectedItem(scmCoc.getPortLin());
			this.cbbWrapType.setSelectedItem(scmCoc.getWarp());
		}
	}
	private void fillData() {

		this.makeCusomsDeclarationParam.setDelcarationDate(this.cbbDeclarationDate
				.getDate());
		...
		this.makeCusomsDeclarationParam.setCustomer(scmCoc);
		// this.makeCusomsDeclarationParam
