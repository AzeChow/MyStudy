 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DgTransCustomsCollate extends JDialogBase {
	...
	class find extends Thread{
		...
		public void run(){
			 try {
			    ...
			    lsResult = transferFactoryManageAction.traCustomsCollate(new Request(
						CommonVars.getCurrUser()),year,isType);
				
				CommonProgress.closeProgressDialog();
			 } catch (Exception e) {
		        CommonProgress.closeProgressDialog();
		        JOptionPane.showMessageDialog(DgTransCustomsCollate.this,
