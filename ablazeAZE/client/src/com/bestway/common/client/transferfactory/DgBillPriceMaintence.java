...
public class DgBillPriceMaintence extends DgCommon {
	...
	private BillPriceMaintenance billPriceMaintenance = null; // @jve:decl-index=0:
	...
	public void setVisible(boolean isFlag) {
		billPriceMaintenance = (BillPriceMaintenance) getTableModel()
				.getCurrentRow();
		showData();
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					try {
						...
						JOptionPane.showMessageDialog(
								DgBillPriceMaintence.this, "请输入正确的数字！", "提示！",
	...
	class EiditThread extends Thread {
		...
		public void run() {
			try {
				...
				transferFactoryManageAction.editBillPriceMaintenancePrice(
				...
				transferFactoryManageAction.saveBillPriceMaintenance(
						new Request(CommonVars.getCurrUser()), list);
				tableModel.updateRow(billPriceMaintenance);
			} catch (Exception e) {

				JOptionPane.showMessageDialog(DgBillPriceMaintence.this,
						"修改过程中失败:" + e.getMessage(), "提示",
						JOptionPane.ERROR_MESSAGE);
			} finally {
				DgBillPriceMaintence.this.dispose();
