...
public class PnMakeCustomsBillList3 extends PnCommon {
    ...
    private void selectAll(boolean isSelected) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i) instanceof TempTransferFactoryCommodityInfo) {
                TempTransferFactoryCommodityInfo temp = (TempTransferFactoryCommodityInfo) list
                        .get(i);
...
//        }
    ...
    class CheckBoxEditor extends DefaultCellEditor implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (obj instanceof TempTransferFactoryCommodityInfo) {
                TempTransferFactoryCommodityInfo temp = (TempTransferFactoryCommodityInfo) obj;
    ...
    private boolean checkValue(JTable table, int row, int column) {
        ...
        TempTransferFactoryCommodityInfo data = (TempTransferFactoryCommodityInfo) tableModel
                .getObjectByRow(row);
        for (int i = 0; i < colorList.size(); i++) {
            TempTransferFactoryCommodityInfo c = (TempTransferFactoryCommodityInfo) colorList
                    .get(i);
