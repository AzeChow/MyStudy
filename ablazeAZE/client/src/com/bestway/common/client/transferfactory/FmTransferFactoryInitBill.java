 ...
 */
public class FmTransferFactoryInitBill extends JInternalFrameBase {
	 ...
	 * 
	 */
	public FmTransferFactoryInitBill() {
		super();
		initialize();
	}
	...
	private void setState() {
		TransferFactoryInitBill initBill = null;
		if (jTabbedPane.getSelectedIndex() == 0) {
			initBill = (TransferFactoryInitBill) importTableModel
					.getCurrentRow();
		} else {
			initBill = (TransferFactoryInitBill) exportTableModel
					.getCurrentRow();
		}
		if (initBill != null) {
		...
		if (btnAdd == null) {
			...
			btnAdd.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					DgTransferFactoryInitBill dg = new DgTransferFactoryInitBill();
			...
			btnDelete.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (JOptionPane.showConfirmDialog(
							FmTransferFactoryInitBill.this, "是否确定删除数据!!!",
							"提示", 0) != 0) {
						return;
					}
					TransferFactoryInitBill transferFactoryInitBill = (TransferFactoryInitBill) tableModel
							.getCurrentRow();
					transferFactoryManageAction.deleteTransferFactoryInitBill(
