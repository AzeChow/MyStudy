 ...
 */
public class DgFptInitBillItem extends JDialogBase {
    ...
    private FptInitBillItem       commInfo                    = null;
	...
	public void setVisible(boolean b) {
        if (b) {
            commInfo = (FptInitBillItem) tableModel
                    .getCurrentRow();
            showData();
            setState();
        }
