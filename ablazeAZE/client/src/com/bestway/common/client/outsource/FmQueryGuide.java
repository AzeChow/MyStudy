 ...
 */
public class FmQueryGuide extends JInternalFrameBase {
	...
	public FmQueryGuide() {
		...
		outsourceAuthority.checkOutsourceDetailReportByBrowse(new Request(
	...
	private JRadioButton getRbMateriel() {
		if (rbMateriel == null) {
			...
			rbMateriel.setText("委外(料件明细)");
			rbMateriel.setBounds(64, 51, 137, 21);
		}
		return rbMateriel;
	}
	...
	private JPanel getJPanel2() {
		if (jPanel2 == null) {
			...
			jPanel2.add(getRbMateriel(), null);
			jPanel2.add(getRbHalfProduct(), null);
		}
		return jPanel2;
	}
	...
	private void initUIComponents() {
		...
		btnExit.setBounds(this.jPanel1.getWidth() - 92, this.jPanel1
				.getHeight() - 40, 68, 26);
		//
		jPanel2.setBounds(28, 28, this.getWidth() - 28 - 28, this.jPanel1
				.getHeight() - 98);
	}
	...
	private class RadioActionListner implements ActionListener {
		public void actionPerformed(java.awt.event.ActionEvent e) {
			...
			try {
				...
				if (rbMateriel.isSelected()) {

					String flag = rbMateriel.getActionCommand();
					JDialogBase dialog = JDialogBaseHelper
							.getJDialogBaseByFlag(flag);
					if (dialog == null) {
						DgOutSourceDetailQuery dgFactoryQuery = new DgOutSourceDetailQuery();
				...
				//
					...
					String flag = rbHalfProduct.getActionCommand();
					JDialogBase dialog = JDialogBaseHelper
							.getJDialogBaseByFlag(flag);
					if (dialog == null) {
						DgOutSourceDetailQuery dgFactoryQuery = new DgOutSourceDetailQuery();
	...
	private JRadioButton getRbHalfProduct() {
		if (rbHalfProduct == null) {
			...
			rbHalfProduct.setBounds(new java.awt.Rectangle(64, 85, 164, 23));
			rbHalfProduct.setText("委外(半成品明细)");
		}
