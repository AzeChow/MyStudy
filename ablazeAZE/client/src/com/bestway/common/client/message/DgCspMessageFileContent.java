...
public class DgCspMessageFileContent extends JDialogBase {
	...
	private CspMessageAction cspMessageAction = null;
	...
	public DgCspMessageFileContent() {
		super();
		initialize();
//		cspMessageAction = (BcsMessageAction) CommonVars
//				.getApplicationContext().getBean("bcsMessageAction");
	...
	private void showTreeData() {
		Map map = cspMessageAction.readCspMessageFileContent(new Request(
...
//							list.add(addColumn("", 300));
						...
						// if (objList != null && objList.size() > 0 && cls !=
						// null) {
						// if(CommonVariables.isSingleBasicType(cls.getName())){
