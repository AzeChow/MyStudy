 ...
 * 
 */
public class DgBlsCorrespondFile extends JDialogBase {
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			...
			jLabel821.setBounds(new Rectangle(32, 132, 104, 24));
			jLabel821.setText("\u89c4\u683c\uff0c\u578b\u53f7");
			jLabel821.setForeground(Color.blue);
			jLabel811 = new JLabel();
			jLabel811.setBounds(new Rectangle(32, 106, 104, 23));
			jLabel811.setText("\u5546\u54c1\u540d\u79f0");
			jLabel811.setForeground(Color.blue);
			jLabel10 = new JLabel();
			jLabel10.setBounds(new Rectangle(32, 185, 106, 21));
			...
			jPanel.setBounds(18, 15, 295, 231);
			jPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
					...
					null));
			jLabel.setText("序号");
			jLabel.setBounds(32, 29, 106, 21);
			jLabel1.setBounds(32, 54, 106, 21);
			jLabel1.setText("料号");
			jLabel2.setBounds(32, 80, 106, 21);
			jLabel2.setText("10位商品编码");
			jLabel4.setBounds(32, 158, 106, 21);
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			jLabel82 = new JLabel();
			jLabel82.setBounds(new Rectangle(31, 97, 95, 21));
			jLabel82.setText("\u89c4\u683c\uff0c\u578b\u53f7");
			jLabel82.setForeground(Color.blue);
			jLabel81 = new JLabel();
			jLabel81.setBounds(new Rectangle(31, 73, 99, 22));
			...
			jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(
					...
					javax.swing.border.TitledBorder.DEFAULT_POSITION, null,
					null));
			jLabel6.setBounds(31, 27, 100, 21);
			jLabel6.setText("备案序号");
			jLabel7.setBounds(31, 50, 100, 21);
			jLabel7.setText("10位商品编码");
			jLabel9.setBounds(31, 122, 100, 21);
	...
	private JComboBox getCbbSerialNo() {
		if (cbbSerialNo == null) {
			...
			cbbSerialNo.setBounds(137, 29, 130, 20);
		}
		return cbbSerialNo;
	}
	...
	private JComboBox getCbbBeforeMaterielCode() {
		if (cbbBeforeMaterielCode == null) {
			...
			cbbBeforeMaterielCode.setBounds(137, 57, 130, 20);
		}
	...
	private JComboBox getCbbBeforeTenComplexCode() {
		if (cbbBeforeTenComplexCode == null) {
			...
			cbbBeforeTenComplexCode.setBounds(137, 82, 130, 20);
		}
	...
	private JComboBox getCbbBeforeUnit() {
		if (cbbBeforeUnit == null) {
			...
			cbbBeforeUnit.setBounds(137, 161, 130, 20);
		}
	...
	private JComboBox getCbbAfterTenMemoNo() {
		if (cbbAfterTenMemoNo == null) {
			...
			cbbAfterTenMemoNo.setBounds(137, 31, 130, 20);
		}
	...
	private JComboBox getCbbAfterTenComplexCode() {
		if (cbbAfterTenComplexCode == null) {
			...
			cbbAfterTenComplexCode.setBounds(137, 54, 130, 20);
		}
	...
	private JComboBox getCbbAfterUnit() {
		if (cbbAfterUnit == null) {
			...
			cbbAfterUnit.setBounds(137, 122, 130, 20);
		}
		return cbbAfterUnit;
	}
...
//		fillComboBox(this.cbbAfterComplexNameSpec);
	...
	private void getSelectedValue() {
		...
		selectedValues.put(Integer.valueOf(BlsInnerMergeFileData.SERIAL_NO),
...
//				getComboBoxSelectValue(this.cbbBeforeMaterielNameSpec));
		selectedValues.put(Integer
				.valueOf(BlsInnerMergeFileData.BEFORE_MATERIEL_NAME),
				getComboBoxSelectValue(this.cbbBeforeMaterielName));
		selectedValues.put(Integer
				.valueOf(BlsInnerMergeFileData.BEFORE_MATERIEL_SPEC),
				getComboBoxSelectValue(this.cbbBeforeMaterielSpec));
		selectedValues.put(Integer.valueOf(BlsInnerMergeFileData.BEFORE_UNIT),
				getComboBoxSelectValue(this.cbbBeforeUnit));
		selectedValues.put(Integer
				.valueOf(BlsInnerMergeFileData.BEFORE_ENTERPRISE_UNIT),
				getComboBoxSelectValue(this.cbbEnterpriseUnit));
		selectedValues.put(Integer
				.valueOf(BlsInnerMergeFileData.AFTER_TEN_MEMO_NO),
...
//		selectedValues.put(Integer
//				.valueOf(BlsInnerMergeFileData.AFTER_COMPLEX_NAME_SPEC),
//				getComboBoxSelectValue(this.cbbAfterComplexNameSpec));
		selectedValues.put(Integer
				.valueOf(BlsInnerMergeFileData.AFTER_COMPLEX_NAME),
				getComboBoxSelectValue(this.cbbAfterComplexName));
		selectedValues.put(Integer
				.valueOf(BlsInnerMergeFileData.AFTER_COMPLEX_SPEC),
				getComboBoxSelectValue(this.cbbAfterComplexSpec));
		selectedValues.put(Integer.valueOf(BlsInnerMergeFileData.AFTER_UNIT),
				getComboBoxSelectValue(this.cbbAfterUnit));
		selectedValues.put(Integer.valueOf(BlsInnerMergeFileData.UNIT_CONVERT),
				getComboBoxSelectValue(this.cbbUnitConvert));
		selectedValues.put(Integer.valueOf(BlsInnerMergeFileData.UNIT_WEIGHT),
	...
	private void restoreInitValues() {
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.SERIAL_NO)) == null) {
			setComboBoxInitValue(this.cbbSerialNo,
					BlsInnerMergeFileData.SERIAL_NO);
		} else {
			this.cbbSerialNo.setSelectedIndex(ItemProperty.getIndexByCode(
					String.valueOf(selectedValues.get(Integer
							.valueOf(BlsInnerMergeFileData.SERIAL_NO) + 1)),
					this.cbbSerialNo));
		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.BEFORE_MATERIEL_CODE)) == null) {
							...
							.getIndexByCode(
									String
											.valueOf(selectedValues
													.get(Integer
															.valueOf(BlsInnerMergeFileData.BEFORE_MATERIEL_CODE)) + 1),
									this.cbbBeforeMaterielCode));
		}
		if (selectedValues == null
				|| selectedValues
						.get(Integer
								.valueOf(BlsInnerMergeFileData.BEFORE_TEN_COMPLEX_CODE)) == null) {
					...
					.setSelectedIndex(ItemProperty
							.getIndexByCode(
									String
											.valueOf(selectedValues
													.get(Integer
															.valueOf(BlsInnerMergeFileData.BEFORE_TEN_COMPLEX_CODE)) + 1),
									this.cbbBeforeTenComplexCode));
		}
//		if (selectedValues == null
//				|| selectedValues
//						.get(Integer
//								.valueOf(BlsInnerMergeFileData.BEFORE_MATERIEL_NAME_SPEC)) == null) {
...
//											.valueOf(selectedValues
//													.get(Integer
//															.valueOf(BlsInnerMergeFileData.BEFORE_MATERIEL_NAME_SPEC)) + 1),
//									this.cbbBeforeMaterielNameSpec));
//		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.BEFORE_MATERIEL_NAME)) == null) {
					...
					.setSelectedIndex(ItemProperty
							.getIndexByCode(
									String
											.valueOf(selectedValues
													.get(Integer
															.valueOf(BlsInnerMergeFileData.BEFORE_MATERIEL_NAME)) + 1),
									this.cbbBeforeMaterielName));
		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.BEFORE_MATERIEL_SPEC)) == null) {
					...
					.setSelectedIndex(ItemProperty
							.getIndexByCode(
									String
											.valueOf(selectedValues
													.get(Integer
															.valueOf(BlsInnerMergeFileData.BEFORE_MATERIEL_SPEC)) + 1),
									this.cbbBeforeMaterielSpec));
		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.BEFORE_UNIT)) == null) {
			...
			this.cbbBeforeUnit.setSelectedIndex(ItemProperty.getIndexByCode(
					String.valueOf(selectedValues.get(Integer
							.valueOf(BlsInnerMergeFileData.BEFORE_UNIT)) + 1),
					this.cbbBeforeUnit));
		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.BEFORE_ENTERPRISE_UNIT)) == null) {
					...
					.setSelectedIndex(ItemProperty
							.getIndexByCode(
									String
											.valueOf(selectedValues
													.get(Integer
															.valueOf(BlsInnerMergeFileData.BEFORE_ENTERPRISE_UNIT)) + 1),
									this.cbbEnterpriseUnit));
		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.AFTER_TEN_MEMO_NO)) == null) {
					...
					.setSelectedIndex(ItemProperty
							.getIndexByCode(
									String
											.valueOf(selectedValues
													.get(Integer
															.valueOf(BlsInnerMergeFileData.AFTER_TEN_MEMO_NO)) + 1),
									this.cbbAfterTenMemoNo));
		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.AFTER_TEN_COMPLEX_CODE)) == null) {
					...
					.setSelectedIndex(ItemProperty
							.getIndexByCode(
									String
											.valueOf(selectedValues
													.get(Integer
															.valueOf(BlsInnerMergeFileData.AFTER_TEN_COMPLEX_CODE)) + 1),
									this.cbbAfterTenComplexCode));
...
//				|| selectedValues
//						.get(Integer
//								.valueOf(BlsInnerMergeFileData.AFTER_COMPLEX_NAME_SPEC)) == null) {
...
//											.valueOf(selectedValues
//													.get(Integer
//															.valueOf(BlsInnerMergeFileData.AFTER_COMPLEX_NAME_SPEC)) + 1),
//									this.cbbAfterComplexNameSpec));
//		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.AFTER_COMPLEX_NAME)) == null) {
					...
					.setSelectedIndex(ItemProperty
							.getIndexByCode(
									String
											.valueOf(selectedValues
													.get(Integer
															.valueOf(BlsInnerMergeFileData.AFTER_COMPLEX_NAME)) + 1),
									this.cbbAfterComplexName));
		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.AFTER_COMPLEX_SPEC)) == null) {
					...
					.setSelectedIndex(ItemProperty
							.getIndexByCode(
									String
											.valueOf(selectedValues
													.get(Integer
															.valueOf(BlsInnerMergeFileData.AFTER_COMPLEX_SPEC)) + 1),
									this.cbbAfterComplexSpec));
		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.AFTER_UNIT)) == null) {
			...
			this.cbbAfterUnit.setSelectedIndex(ItemProperty.getIndexByCode(
					String.valueOf(selectedValues.get(Integer
							.valueOf(BlsInnerMergeFileData.AFTER_UNIT)) + 1),
					this.cbbAfterUnit));
		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.UNIT_CONVERT)) == null) {
			...
			this.cbbUnitConvert.setSelectedIndex(ItemProperty.getIndexByCode(
					String.valueOf(selectedValues.get(Integer
							.valueOf(BlsInnerMergeFileData.UNIT_CONVERT)) + 1),
					this.cbbUnitConvert));
		}
		if (selectedValues == null
				|| selectedValues.get(Integer
						.valueOf(BlsInnerMergeFileData.UNIT_WEIGHT)) == null) {
			...
			this.cbbUnitWeight.setSelectedIndex(ItemProperty.getIndexByCode(
					String.valueOf(selectedValues.get(Integer
							.valueOf(BlsInnerMergeFileData.UNIT_WEIGHT)) + 1),
					this.cbbUnitWeight));
		}
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					BlsInnerMergeDataOrder order = blsInnerMergeAction
							.findBlsInnerMergeDataOrder(new Request(CommonVars
									.getCurrUser(), true));
					fillData(order);
					blsInnerMergeAction.saveBlsInnerMergeDataOrder(new Request(
	...
	private JComboBox getCbbEnterpriseUnit() {
		if (cbbEnterpriseUnit == null) {
			...
			cbbEnterpriseUnit.setBounds(new Rectangle(137, 187, 130, 20));
		}
	...
	private JComboBox getCbbBeforeMaterielName() {
		if (cbbBeforeMaterielName == null) {
			...
			cbbBeforeMaterielName.setBounds(new Rectangle(137, 109, 130, 20));
...
//							}
	...
	private JComboBox getCbbBeforeMaterielSpec() {
		if (cbbBeforeMaterielSpec == null) {
			...
			cbbBeforeMaterielSpec.setBounds(new Rectangle(137, 135, 130, 20));
...
//							}
	...
	private JComboBox getCbbAfterComplexName() {
		if (cbbAfterComplexName == null) {
			...
			cbbAfterComplexName.setBounds(new Rectangle(137, 78, 130, 20));
			cbbAfterComplexName
					.addItemListener(new java.awt.event.ItemListener() {
						public void itemStateChanged(java.awt.event.ItemEvent e) {
...
//							}
	...
	private JComboBox getCbbAfterComplexSpec() {
		if (cbbAfterComplexSpec == null) {
			...
			cbbAfterComplexSpec.setBounds(new Rectangle(137, 97, 130, 20));
			cbbAfterComplexSpec
					.addItemListener(new java.awt.event.ItemListener() {
						public void itemStateChanged(java.awt.event.ItemEvent e) {
...
//							}
	...
	private void fillData(BlsInnerMergeDataOrder order) {
