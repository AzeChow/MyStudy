 ...
 */
public class OwpBillRecvItem extends BaseScmEntity {
	private static final long serialVersionUID = 6040001214372959687L;

	/**
	 * 收货单表头
	 */
	private OwpBillRecvHead head;
	/**
	 * 序号
	 */
	 ...
	 * @return
	 */
	public OwpBillRecvHead getHead() {
		return head;
	}
	 ...
	 * @param head
	 */
	public void setHead(OwpBillRecvHead head) {
		this.head = head;
	}
