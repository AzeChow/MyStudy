...
public class ECSAttachmentManagement extends BaseScmEntity {
	...
	public static final String PRINT_BEGINDELCARE = "20";//打印预报核
	public static final String PRINT_DELCARE = "21";//打印正式报核
	public static final String PRINT_DELCARE_ONE = "22";//打印正式报核前一次
	public static final String PRINT_DELCARE_TWO = "23";//打印正式报核前两次
	
	//批次
	public ECSSection ecssection;
	 ...
	 * 子节点
	 */
	private List<ECSAttachmentManagement> children = null;
	
	public List<ECSAttachmentManagement> getChildren() {
		return children;
	}

	public void setChildren(List<ECSAttachmentManagement> children) {
