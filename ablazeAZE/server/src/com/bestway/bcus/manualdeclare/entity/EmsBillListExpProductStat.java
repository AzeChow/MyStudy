 ...
 */
public class EmsBillListExpProductStat implements Serializable{
//	private Complex complex;
	...
	public Double getBigExpAmount() {
		return bigExpAmount;
	}

	public void setBigExpAmount(Double bigExpAmount) {
		this.bigExpAmount = bigExpAmount;
	}
	...
	public Double getUseingAmount() {
		return useingAmount;
	}

	public void setUseingAmount(Double useingAmount) {
		this.useingAmount = useingAmount;
	}
