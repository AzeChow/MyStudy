 ...
 */
public class EmsBillListImpMaterialStat implements Serializable{
	/**
	 * 料号
	 */
	...
	public Double getBigImpAmount() {
		return bigImpAmount;
	}

	public void setBigImpAmount(Double bigImpAmount) {
		this.bigImpAmount = bigImpAmount;
	}
