 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */ //归并前料件
public class EmsEdiMergerImgBefore extends BaseScmEntity {
	private static final long serialVersionUID = CommonUtils.getSerialVersionUID();
	/**
	 * 归并后料件
	 */
	private EmsEdiMergerImgAfter emsEdiMergerImgAfter; 
	/**
	 * 料件序号
	 */
	...
	*//**
	...
	public EmsEdiMergerHead getEmsEdiMergerHead() {
		return emsEdiMergerImgAfter.getEmsEdiMergerHead();
	}

	/**
	 * @return Returns the emsEdiMergerImgAfter.
	 */
	public EmsEdiMergerImgAfter getEmsEdiMergerImgAfter() {
		return emsEdiMergerImgAfter;
	}
	/**
	 * @param emsEdiMergerImgAfter The emsEdiMergerImgAfter to set.
	 */
	public void setEmsEdiMergerImgAfter(
			EmsEdiMergerImgAfter emsEdiMergerImgAfter) {
		this.emsEdiMergerImgAfter = emsEdiMergerImgAfter;
	}
	/**
