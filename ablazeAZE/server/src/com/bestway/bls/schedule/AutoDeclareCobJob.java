...
public class AutoDeclareCobJob implements StatefulJob  {//Job
	private static Log logger = LogFactory.getLog(AutoDeclareCobJob.class);
	...
	public void execute(JobExecutionContext context)
		...
		scheduleLogic.allAutoDeclareCollateBind(company);
		if (scheduleLogic.getIsAutoProcess(company)) {
			scheduleLogic.allAutoProcessCollateBind(company);
		}
	}
