 ...
 */
public class FptInitBillItem extends BaseScmEntity {
	...
	private FptInitBill fptInitBill = null;
	/**
	 * 手册号
	 */
	 ...
	 */
	public FptInitBill getFptInitBill() {
		return fptInitBill;
	}
	 ...
	 */
	public void setFptInitBill(
			FptInitBill transferFactoryInitBill) {
		this.fptInitBill = transferFactoryInitBill;
	}
