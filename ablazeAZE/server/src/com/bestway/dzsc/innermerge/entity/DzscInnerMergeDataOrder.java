 ...
 */
public class DzscInnerMergeDataOrder extends BaseScmEntity {
	 ...
	 * 法定单位比例因子
	 */
	private Integer legalUnitGene;

	/**
	 * 第二法定单位比例因子
	 */
	private Integer legalUnit2Gene;

	/**
	 * 重量单位比例因子
	 */
	private Integer weigthUnitGene;

	/**
	 * 4位编码序号
	 */
	private Integer fourNo;

	/**
	 * 4位商品名称
	 */
	private Integer fourComplexName;

	/**
	 * 4位商品编码
	 */
	private Integer fourComplexCode;

	/**
	 * 4位单位
	 */
	private Integer fourUnit;
	 ...
	 */
	public Integer getFourComplexCode() {
	 ...
	 */
	public void setFourComplexCode(Integer fourMaterielCode) {
	 ...
	 */
	public Integer getFourComplexName() {
	 ...
	 */
	public void setFourComplexName(Integer fourMaterielName) {
	 ...
	 *            The fourNo to set.
	 */
	public void setFourNo(Integer fourNo) {
		this.fourNo = fourNo;
	}
	...
	public Integer getFourUnit() {
		return fourUnit;
	}

	public void setFourUnit(Integer fourUnit) {
	...
	public Integer getLegalUnit2Gene() {
		return legalUnit2Gene;
	}

	public void setLegalUnit2Gene(Integer legalUnit2Gene) {
		this.legalUnit2Gene = legalUnit2Gene;
	}

	public Integer getLegalUnitGene() {
		return legalUnitGene;
	}

	public void setLegalUnitGene(Integer legalUnitGene) {
		this.legalUnitGene = legalUnitGene;
	}

	public Integer getWeigthUnitGene() {
		return weigthUnitGene;
	}

	public void setWeigthUnitGene(Integer weigthUnitGene) {
