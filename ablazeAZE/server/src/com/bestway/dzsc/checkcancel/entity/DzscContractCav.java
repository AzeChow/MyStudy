 ...
 */
public class DzscContractCav extends BaseScmEntity {
	 ...
	 * 
	 * @param isCustoms 海关、自用判断，true代表是海关用
	 */
	 ...
	 * 设置内销补税单号
	 * 
	 * @param internalSaleTaxBill 内销补税单号
	 */
	 ...
	 * 设置内销批准证号
	 * 
	 * @param internalSaleWarrant 内销批准证号
	 */
	 ...
	 * 设置是否限制商品
	 * 
	 * @param isLimit 是否限制商品，true为限制商品
	 */
	 ...
	 * 设置是否敏感商品
	 * 
	 * @param isSusceptivity 是否敏感商品，true为敏感商品
	 */
	...
	public void setCreateDate(Date inputDate) {
