 ...
 * @author
 */
public class DzscEmsPorWjHead extends BaseContractHead {
	...
	/**
	 * 电子手册监管模式 0：料号级 1：HS编码级
	 */
	private Integer dzscManageType = 0;
	...
	public String getCustomsModifyMark() {
		return DzscCustomsModifyState.getCustomsModifyState(this.modifyMark);
	}
	...
	public Integer getDzscManageType() {
		return dzscManageType;
	}

	public void setDzscManageType(Integer dzscManageType) {
		this.dzscManageType = dzscManageType;
	}
