 ...
 *
 */
public class StrikeImpCustomsDeclaration extends BaseScmEntity {
	...
	/**
	 * 设置进口报关单号
	 * @param customsDeclarationCode 进口报关单号
	 */
	...
	/**
	 * 生成进口报关单ID
	 * @param customsDeclarationId 进口报关单ID
	 */
