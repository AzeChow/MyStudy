...
/**
 * 临时实体类，存放报关分析－－成品执行情况分析－－出口成品统计资料
 */
public class ExpFinishProductStat implements Serializable {
     ...
     * 可直接出口量
     */
    private Double canDirectExpAmount         = null; 
	...
	public Double getCompleteScale() {
		return totalExpAmount*100 / contractTotalAmount ;
	}
	 ...
	 * 获取可直接出口量
	 * 
	 * @return canDirectExpAmount 可直接出口量
	 */
	public Double getCanDirectExpAmount() {
		return canDirectExpAmount;
	}

	/**
	 * 设置可直接出口量
	 * 
	 * @param canDirectExpAmount 可直接出口量
	 */
	public void setCanDirectExpAmount(Double canDirectExpAmount) {
		this.canDirectExpAmount = canDirectExpAmount;
	}
	...
	public void setCustomsEnvelopRemainAmount(Double customsEnvelopRemainAmount) {
		this.customsEnvelopRemainAmount = customsEnvelopRemainAmount;
	}
