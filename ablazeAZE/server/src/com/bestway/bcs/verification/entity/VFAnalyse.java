 ...
 *
 */
public class VFAnalyse extends BaseScmEntity {
	...
	public void init(){
		...
		this.stockAmountSemiExgHadStore = 0.0;
		this.stockAmountFinishing = 0.0;
		this.stockAmountBad = 0.0;
