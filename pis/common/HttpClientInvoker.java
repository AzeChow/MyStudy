...
//       String urlAddress = "http://127.0.0.1:8080/core-war/HttpInvokeTest";//
       String urlAddress = "http://192.168.1.52:8080/esp-war/webdirect.jnlp.jsp?href=http%3A//192.168.1.52%3A8080/esp-war/&useremail=1111111111&userpwd=2222222222";//
//       String urlAddress = "http://ip.cn";
   ...
   public String executeMethod(String url, Map<String, String> params, HttpProxyParam proxyParam) {
       ...
       postMethod.setRequestBody(listParams.toArray(new NameValuePair[listParams.size()]));
       try {
           // 执行postMethod
   ...
   private String readContentFromResponseStream(PostMethod postMethod) {
       ...
       try {
           in = new BufferedReader(new InputStreamReader(postMethod.getResponseBodyAsStream(), postMethod
                   .getResponseCharSet()));
           System.out.println(" ResponseCharSet:" + postMethod
                   .getResponseCharSet());
           ...
           Logger.getLogger(MsgHttpClientUtil.class.getName()).log(Level.SEVERE, null, ex);
       } finally {
           if (in != null) {
               try {
                   in.close();
